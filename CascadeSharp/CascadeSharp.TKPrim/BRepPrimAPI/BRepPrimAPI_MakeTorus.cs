...
namespace CascadeSharp.TKPrim.BRepPrimAPI
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepPrimAPI_MakeTorus : BRepPrimAPI_MakeOneAxis
	{
		...
		public BRepPrimAPI_MakeTorus(BRepPrimAPI_MakeTorus parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepPrimAPI_MakeTorus()
		{
			throw new NotImplementedException();
		}
