...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepSweep_Translation : CascadeSharp.BRepSweep_Trsf
	{

		public BRepSweep_Translation(TopoDS_Shape S, Sweep_NumShape N, TopLoc_Location L, gp_Vec V, bool C, bool Canonize)
			: base()
		{
