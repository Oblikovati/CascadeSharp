...
namespace CascadeSharp.TKG3d.Adaptor3d
{
    ...
    public sealed class Adaptor3d_CurveOnSurface : Adaptor3d_Curve
    {
        ...
        public bool LocatePart_RevExt(gp_Pnt2d UV, gp_Vec2d DUV, Adaptor3d_HSurface S, gp_Pnt2d LeftBot,
            gp_Pnt2d RightTop)
        {
            throw new NotImplementedException();
        }
        ...
        public void FindBounds(TColStd_Array1OfReal Arr, double XYComp, double DUVComp, ref int Bnd1, ref int Bnd2,
            ref bool DerIsNull)
        {
            throw new NotImplementedException();
        }
