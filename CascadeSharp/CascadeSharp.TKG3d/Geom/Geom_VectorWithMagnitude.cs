...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class Geom_VectorWithMagnitude : CascadeSharp.Geom_Vector
	{
		...
		public Geom_VectorWithMagnitude(Geom_VectorWithMagnitude parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom_VectorWithMagnitude()
		{
			throw new NotImplementedException();
		}
