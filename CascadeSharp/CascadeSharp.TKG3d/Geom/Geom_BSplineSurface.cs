...
namespace CascadeSharp.TKG3d.Geom
{
	...
	public  sealed class Geom_BSplineSurface : Geom_BoundedSurface
	{
		...
		public Geom_BSplineSurface(TColgp_Array2OfPnt Poles, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots, TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool UPeriodic)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public Geom_BSplineSurface(TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots, TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool UPeriodic, bool VPeriodic)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom_BSplineSurface(TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots, TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool UPeriodic)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void InsertUKnots(TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, double ParametricTolerance, bool Add)
		{
			throw new NotImplementedException();
		}
		...
		public void InsertVKnots(TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, double ParametricTolerance, bool Add)
		{
			throw new NotImplementedException();
		}
		...
		public void CheckAndSegment(double U1, double U2, double V1, double V2, double theUTolerance, double theVTolerance)
		{
			throw new NotImplementedException();
		}
		...
		public void MovePoint(double U, double V, gp_Pnt P, int UIndex1, int UIndex2, int VIndex1, int VIndex2, ref int UFirstIndex, ref int ULastIndex, ref int VFirstIndex, ref int VLastIndex)
		{
			throw new NotImplementedException();
		}
						...
						public char get_type_name()
		{
			throw new NotImplementedException("Native class returns pointer to integer/double/handle.");
						...
						public void segment(double U1, double U2, double V1, double V2, double EpsU, double EpsV, bool SegmentInU, bool SegmentInV)
		{
			throw new NotImplementedException();
		}
