...
namespace CascadeSharp
{
	...
	public  sealed class Geom_BSplineCurve : CascadeSharp.Geom_BoundedCurve
	{
		...
		public Geom_BSplineCurve(TColgp_Array1OfPnt Poles, TColStd_Array1OfReal Weights, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Multiplicities, int Degree, bool Periodic, bool CheckRational)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom_BSplineCurve(TColgp_Array1OfPnt Poles, TColStd_Array1OfReal Weights, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Multiplicities, int Degree, bool Periodic)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void MovePoint(double U, gp_Pnt P, int Index1, int Index2, ref int FirstModifiedPole, ref int LastModifiedPole)
		{
			throw new NotImplementedException();
		}

		public void MovePointAndTangent(double U, gp_Pnt P, gp_Vec Tangent, double Tolerance, int StartingCondition, int EndingCondition, ref int ErrorStatus)
		{
			throw new NotImplementedException();
		}
