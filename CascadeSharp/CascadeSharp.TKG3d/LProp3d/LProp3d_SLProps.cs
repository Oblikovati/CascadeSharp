...
namespace CascadeSharp.TKG3d.LProp3d
{
    ...
    //---------------------------------------------------------------------
    public sealed class LProp3d_SLProps
    {
        public LProp3d_SLProps(Adaptor3d_HSurface S, double U, double V, int N, double Resolution)
            : base()
        {
        ...
        public LProp3d_SLProps(int N, double Resolution)
            : base()
        {
            throw new NotImplementedException();
        }

        public LProp3d_SLProps(LProp3d_SLProps parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public LProp3d_SLProps()
        {
            throw new NotImplementedException();
        }
