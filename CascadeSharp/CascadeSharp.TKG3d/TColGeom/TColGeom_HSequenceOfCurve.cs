...
namespace CascadeSharp.TKG3d.TColGeom
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColGeom_HSequenceOfCurve : Standard_Transient
    {
        public TColGeom_HSequenceOfCurve()
            : base()
        {
        ...
        public TColGeom_HSequenceOfCurve(TColGeom_HSequenceOfCurve parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public TColGeom_SequenceOfCurve Sequence()
        {
            throw new NotImplementedException();
        }
        ...
        public TColGeom_SequenceOfCurve ChangeSequence()
        {
            throw new NotImplementedException();
        }
