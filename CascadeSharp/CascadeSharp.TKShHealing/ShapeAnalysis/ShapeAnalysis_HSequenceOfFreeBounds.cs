...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class ShapeAnalysis_HSequenceOfFreeBounds : Standard_Transient
	{
		...
		public ShapeAnalysis_HSequenceOfFreeBounds(ShapeAnalysis_HSequenceOfFreeBounds parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
