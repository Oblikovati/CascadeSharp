...
namespace CascadeSharp.TKShHealing.ShapeAnalysis
{
	...
	public  sealed class ShapeAnalysis_Curve
	{
		...
		public double Project(Geom_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, bool AdjustToEnds)
		{
			throw new NotImplementedException();
		}
		...
		public double Project(Adaptor3d_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, bool AdjustToEnds)
		{
			throw new NotImplementedException();
		}
		...
		public double Project(Geom_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, double cf, double cl, bool AdjustToEnds)
		{
			throw new NotImplementedException();
		}

		public double Project(Geom_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, double cf, double cl)
		{
			throw new NotImplementedException();
		}
		...
		public double NextProject(double paramPrev, Geom_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, double cf, double cl, bool AdjustToEnds)
		{
			throw new NotImplementedException();
		}

		public double NextProject(double paramPrev, Geom_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param, double cf, double cl)
		{
			throw new NotImplementedException();
		}

		public double NextProject(double paramPrev, Adaptor3d_Curve C3D, gp_Pnt P3D, double preci, gp_Pnt proj, ref double param)
		{
			throw new NotImplementedException();
		}
