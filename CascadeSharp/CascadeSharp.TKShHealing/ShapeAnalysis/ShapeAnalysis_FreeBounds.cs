...
namespace CascadeSharp
{
	...
	public  sealed class ShapeAnalysis_FreeBounds
	{
		...
		public void ConnectEdgesToWires(TopTools_HSequenceOfShape edges, double toler, bool shared, TopTools_HSequenceOfShape wires)
		{
			throw new NotImplementedException();
		}

		public void ConnectWiresToWires(TopTools_HSequenceOfShape iwires, double toler, bool shared, TopTools_HSequenceOfShape owires)
		{
			throw new NotImplementedException();
		}

		public void ConnectWiresToWires(TopTools_HSequenceOfShape iwires, double toler, bool shared, TopTools_HSequenceOfShape owires, TopTools_DataMapOfShapeShape vertices)
		{
			throw new NotImplementedException();
		}

		public void SplitWires(TopTools_HSequenceOfShape wires, double toler, bool shared, TopTools_HSequenceOfShape closed, TopTools_HSequenceOfShape open)
		{
			throw new NotImplementedException();
		}
