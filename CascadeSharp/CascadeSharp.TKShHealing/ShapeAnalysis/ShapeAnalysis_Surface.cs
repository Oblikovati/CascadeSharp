...
namespace CascadeSharp
{
	...
	public  sealed class ShapeAnalysis_Surface : Standard_Transient
	{
		...
		public bool Singularity(int num, ref double preci, gp_Pnt P3d, gp_Pnt2d firstP2d, gp_Pnt2d lastP2d, ref double firstpar, ref double lastpar, ref bool u_isodeg)
		{
			throw new NotImplementedException();
		}
		...
		public bool DegeneratedValues(gp_Pnt P3d, double preci, gp_Pnt2d firstP2d, gp_Pnt2d lastP2d, ref double firstpar, ref double lastpar, bool forward)
		{
			throw new NotImplementedException();
		}

		public bool DegeneratedValues(gp_Pnt P3d, double preci, gp_Pnt2d firstP2d, gp_Pnt2d lastP2d, ref double firstpar, ref double lastpar)
		{
			throw new NotImplementedException();
		}
		...
		public bool ProjectDegenerated(int nbrPnt, TColgp_SequenceOfPnt points, TColgp_SequenceOfPnt2d pnt2d, double preci, bool direct)
		{
			throw new NotImplementedException();
		}
