...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class ShapeFix_ComposeShell : CascadeSharp.ShapeFix_Root
	{
		...
		public int ComputeCode(ShapeExtend_WireData wire, gp_Lin2d line, int begInd, int endInd, double begPar, double endPar, bool IsInternal)
		{
			throw new NotImplementedException();
		}

		public int ComputeCode(ShapeExtend_WireData wire, gp_Lin2d line, int begInd, int endInd, double begPar, double endPar)
		{
			throw new NotImplementedException();
		}

		public ShapeFix_WireSegment SplitWire(ShapeFix_WireSegment wire, TColStd_SequenceOfInteger indexes, TColStd_SequenceOfReal values, TopTools_SequenceOfShape vertices, TColStd_SequenceOfInteger segcodes, bool cutbyu, int cutindex)
		{
			throw new NotImplementedException();
		}

		public bool SplitByLine(ShapeFix_WireSegment wire, gp_Lin2d line, bool cutbyu, int cutindex, TColStd_SequenceOfReal SplitLinePar, TColStd_SequenceOfInteger SplitLineCode, TopTools_SequenceOfShape SplitLineVertex)
		{
			throw new NotImplementedException();
		}
