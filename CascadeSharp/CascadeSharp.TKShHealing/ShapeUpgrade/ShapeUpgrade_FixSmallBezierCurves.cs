...
namespace CascadeSharp.TKShHealing.ShapeUpgrade
{
    ...
    public sealed class ShapeUpgrade_FixSmallBezierCurves : ShapeUpgrade_FixSmallCurves
    {
        ...
        public ShapeUpgrade_FixSmallBezierCurves(ShapeUpgrade_FixSmallBezierCurves parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public bool Approx(Geom_Curve Curve3d, Geom2d_Curve Curve2d, Geom2d_Curve Curve2dR, ref double First,
            ref double Last)
        {
            throw new NotImplementedException();
        }
