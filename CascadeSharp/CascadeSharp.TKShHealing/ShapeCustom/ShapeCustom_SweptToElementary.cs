...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class ShapeCustom_SweptToElementary : CascadeSharp.ShapeCustom_Modification
	{
		...
		public ShapeCustom_SweptToElementary(ShapeCustom_SweptToElementary parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
