...
namespace CascadeSharp.TKShHealing.ShapeCustom
{
	...
	public  sealed class ShapeCustom_BSplineRestriction : ShapeCustom_Modification
	{
		...
		public bool ConvertSurface(Geom_Surface aSurface, Geom_Surface S, double UF, double UL, double VF, double VL, bool IsOf)
		{
			throw new NotImplementedException();
		}
		...
		public bool ConvertCurve(Geom_Curve aCurve, Geom_Curve C, bool IsConvert, double First, double Last, ref double TolCur, bool IsOf)
		{
			throw new NotImplementedException();
		}

		public bool ConvertCurve(Geom_Curve aCurve, Geom_Curve C, bool IsConvert, double First, double Last, ref double TolCur)
		{
			throw new NotImplementedException();
		}

		public bool ConvertCurve2d(Geom2d_Curve aCurve, Geom2d_Curve C, bool IsConvert, double First, double Last, ref double TolCur, bool IsOf)
		{
			throw new NotImplementedException();
		}

		public bool ConvertCurve2d(Geom2d_Curve aCurve, Geom2d_Curve C, bool IsConvert, double First, double Last, ref double TolCur)
		{
			throw new NotImplementedException();
		}
