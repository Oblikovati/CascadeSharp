...
namespace CascadeSharp.TKGeomAlgo.FairCurve
{
	...
	public  sealed class FairCurve_Newton : math_NewtonMinimum
	{
		...
		public FairCurve_Newton(math_MultipleVarFunctionWithHessian theFunction, double theSpatialTolerance, double theCriteriumTolerance, int theNbIterations, double theConvexity)
			: base()
		{
			throw new NotImplementedException();
		}

		public FairCurve_Newton(math_MultipleVarFunctionWithHessian theFunction, double theSpatialTolerance, double theCriteriumTolerance, int theNbIterations)
			: base()
		{
			throw new NotImplementedException();
		}

		public FairCurve_Newton(math_MultipleVarFunctionWithHessian theFunction, double theSpatialTolerance, double theCriteriumTolerance)
			: base()
		{
			throw new NotImplementedException();
		}
