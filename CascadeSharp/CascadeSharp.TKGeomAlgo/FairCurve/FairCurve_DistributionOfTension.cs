...
namespace CascadeSharp
{
	...
	public  sealed class FairCurve_DistributionOfTension : CascadeSharp.FairCurve_DistributionOfEnergy
	{
		...
		public FairCurve_DistributionOfTension(int BSplOrder, TColStd_HArray1OfReal FlatKnots, TColgp_HArray1OfPnt2d Poles, int DerivativeOrder, double LengthSliding, FairCurve_BattenLaw Law, int NbValAux)
			: base()
		{
			throw new NotImplementedException();
		}

		public FairCurve_DistributionOfTension(int BSplOrder, TColStd_HArray1OfReal FlatKnots, TColgp_HArray1OfPnt2d Poles, int DerivativeOrder, double LengthSliding, FairCurve_BattenLaw Law)
			: base()
		{
			throw new NotImplementedException();
		}
