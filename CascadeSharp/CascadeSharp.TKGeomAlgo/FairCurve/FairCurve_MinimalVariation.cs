...
namespace CascadeSharp.TKGeomAlgo.FairCurve
{
    ...
    public sealed class FairCurve_MinimalVariation : FairCurve_Batten
    {
        ...
        public bool Compute(gp_Vec2d DeltaP1, gp_Vec2d DeltaP2, double DeltaAngle1, double DeltaAngle2,
            double DeltaCurvature1, double DeltaCurvature2, ref FairCurve_AnalysisCode ACode, int NbIterations,
            double Tolerance)
        {
            throw new NotImplementedException();
        }
