...
namespace CascadeSharp.TKGeomAlgo.Geom2dInt
{
    ...
    public sealed class Geom2dInt_TheIntersectorOfTheIntConicCurveOfGInter : IntRes2d_Intersection
    {
        ...
        public Geom2dInt_TheIntersectorOfTheIntConicCurveOfGInter(
            Geom2dInt_TheIntersectorOfTheIntConicCurveOfGInter parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public void Perform(IntCurve_IConicTool ITool, IntRes2d_Domain Dom1, Adaptor2d_Curve2d PCurve,
            IntRes2d_Domain Dom2, double TolConf, double Tol)
        {
            throw new NotImplementedException();
        }

        public double FindU(double parameter, gp_Pnt2d point, Adaptor2d_Curve2d TheParCurev,
            IntCurve_IConicTool IntCurve_IConicTool)
        {
            throw new NotImplementedException();
        }

        public double FindV(double parameter, gp_Pnt2d point, IntCurve_IConicTool IntCurve_IConicTool,
            Adaptor2d_Curve2d ParCurve, IntRes2d_Domain TheParCurveDomain, double V0, double V1, double Tolerance)
        {
            throw new NotImplementedException();
        }
