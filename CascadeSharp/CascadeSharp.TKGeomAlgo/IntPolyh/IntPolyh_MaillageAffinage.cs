...
namespace CascadeSharp.TKGeomAlgo.IntPolyh
{
    ...
    {
        public IntPolyh_MaillageAffinage(Adaptor3d_HSurface S1, int NbSU1, int NbSV1, Adaptor3d_HSurface S2, int NbSU2,
            int NbSV2, int PRINT)
            : base()
        {
        ...
        public void CommonBox(Bnd_Box B1, Bnd_Box B2, ref double xMin, ref double yMin, ref double zMin,
