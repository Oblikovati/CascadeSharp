...
namespace CascadeSharp
{
	...
	public  sealed class IntPolyh_StartPoint
	{
		...
		public IntPolyh_StartPoint(double xx, double yy, double zz, double uu1, double vv1, double uu2, double vv2, int T1, int E1, double LAM1, int T2, int E2, double LAM2, int L_ist)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public int GetEdgePoints(IntPolyh_Triangle Triangle, ref int FirstEdgePoint, ref int SecondEdgePoint, ref int LastPoint)
		{
			throw new NotImplementedException();
		}
