...
namespace CascadeSharp.TKGeomAlgo.IntCurveSurface
{
    ...
    public sealed class IntCurveSurface_HInter : IntCurveSurface_Intersection
    {
        ...
        public void Perform(Adaptor3d_HCurve Curve, IntCurveSurface_ThePolygonOfHInter Polygon,
            Adaptor3d_HSurface Surface)
        {
            throw new NotImplementedException();
        }

        public void Perform(Adaptor3d_HCurve Curve, IntCurveSurface_ThePolygonOfHInter ThePolygon,
            Adaptor3d_HSurface Surface, IntCurveSurface_ThePolyhedronOfHInter Polyhedron)
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(Adaptor3d_HCurve Curve, Adaptor3d_HSurface Surface,
            IntCurveSurface_ThePolyhedronOfHInter Polyhedron)
        {
            throw new NotImplementedException();
        }

        public void Perform(Adaptor3d_HCurve Curve, Adaptor3d_HSurface Surface, double U0, double V0, double U1,
            double V1)
        {
            throw new NotImplementedException();
        }
        ...
        public void InternalPerform(Adaptor3d_HCurve Curve, IntCurveSurface_ThePolygonOfHInter Polygon,
            Adaptor3d_HSurface Surface, double U1, double V1, double U2, double V2)
        {
            throw new NotImplementedException();
        }
        ...
        public void PerformConicSurf(gp_Hypr Hyper, Adaptor3d_HCurve Curve, Adaptor3d_HSurface Surface, double U1,
            double V1, double U2, double V2)
        {
            throw new NotImplementedException();
        }
