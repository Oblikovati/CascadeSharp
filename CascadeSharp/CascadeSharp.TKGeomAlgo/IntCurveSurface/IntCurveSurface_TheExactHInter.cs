...
namespace CascadeSharp
{
	...
	public  sealed class IntCurveSurface_TheExactHInter
	{
		...
		public IntCurveSurface_TheExactHInter(double U, double V, double W, IntCurveSurface_TheCSFunctionOfHInter F, double TolTangency, double MarginCoef)
			: base()
		{
			throw new NotImplementedException();
		}

		public IntCurveSurface_TheExactHInter(double U, double V, double W, IntCurveSurface_TheCSFunctionOfHInter F, double TolTangency)
			: base()
		{
			throw new NotImplementedException();
		}
