...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
    ...
    {
        public Geom2dGcc_Circ2d2TanOn(Geom2dGcc_QualifiedCurve Qualified1, Geom2dGcc_QualifiedCurve Qualified2,
            Geom2dAdaptor_Curve OnCurve, double Tolerance, double Param1, double Param2, double ParamOn)
            : base()
        {
