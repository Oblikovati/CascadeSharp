...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
    ...
    {
        public Geom2dGcc_Circ2d3Tan(Geom2dGcc_QualifiedCurve Qualified1, Geom2dGcc_QualifiedCurve Qualified2,
            Geom2dGcc_QualifiedCurve Qualified3, double Tolerance, double Param1, double Param2, double Param3)
            : base()
        {
        ...
        public Geom2dGcc_Circ2d3Tan(Geom2dGcc_QualifiedCurve Qualified1, Geom2dGcc_QualifiedCurve Qualified2,
            Geom2d_Point Point, double Tolerance, double Param1, double Param2)
            : base()
        {
            throw new NotImplementedException();
        }
