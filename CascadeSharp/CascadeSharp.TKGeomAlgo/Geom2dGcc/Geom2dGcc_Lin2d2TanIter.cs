...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
	...
	public  sealed class Geom2dGcc_Lin2d2TanIter
	{
		...
		public Geom2dGcc_Lin2d2TanIter(GccEnt_QualifiedCirc Qualified1, Geom2dGcc_QCurve Qualified2, double Param2, double Tolang)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom2dGcc_Lin2d2TanIter(Geom2dGcc_QCurve Qualified1, Geom2dGcc_QCurve Qualified2, double Param1, double Param2, double Tolang)
			: base()
		{
			throw new NotImplementedException();
		}
