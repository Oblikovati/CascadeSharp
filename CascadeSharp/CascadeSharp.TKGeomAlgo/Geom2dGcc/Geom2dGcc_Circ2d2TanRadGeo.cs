...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
	...
	public  sealed class Geom2dGcc_Circ2d2TanRadGeo
	{
		...
		public Geom2dGcc_Circ2d2TanRadGeo(GccEnt_QualifiedCirc Qualified1, Geom2dGcc_QCurve Qualified2, double Radius, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom2dGcc_Circ2d2TanRadGeo(GccEnt_QualifiedLin Qualified1, Geom2dGcc_QCurve Qualified2, double Radius, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}

		public Geom2dGcc_Circ2d2TanRadGeo(Geom2dGcc_QCurve Qualified1, Geom2dGcc_QCurve Qualified2, double Radius, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}
