...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
	...
	public  sealed class Geom2dGcc_Lin2d2Tan
	{
		...
		public Geom2dGcc_Lin2d2Tan(Geom2dGcc_QualifiedCurve Qualified1, Geom2dGcc_QualifiedCurve Qualified2, double Tolang)
			: base()
		{
		...
		public Geom2dGcc_Lin2d2Tan(Geom2dGcc_QualifiedCurve Qualified1, Geom2dGcc_QualifiedCurve Qualified2, double Tolang, double Param1, double Param2)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public bool Add(int theIndex, Geom2dGcc_Lin2d2TanIter theLin, double theTol, Geom2dAdaptor_Curve theC1, Geom2dAdaptor_Curve theC2)
		{
			throw new NotImplementedException();
		}
