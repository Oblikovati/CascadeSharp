...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
    ...
    {
        public Geom2dGcc_Circ2dTanOnRadGeo(Geom2dGcc_QCurve Qualified1, gp_Lin2d OnLine, double Radius,
            double Tolerance)
            : base()
        {
        ...
        public Geom2dGcc_Circ2dTanOnRadGeo(GccEnt_QualifiedCirc Qualified1, Geom2dAdaptor_Curve OnCurv, double Radius,
            double Tolerance)
            : base()
        {
            throw new NotImplementedException();
        ...
        public Geom2dGcc_Circ2dTanOnRadGeo(GccEnt_QualifiedLin Qualified1, Geom2dAdaptor_Curve OnCurv, double Radius,
            double Tolerance)
            : base()
        {
            throw new NotImplementedException();
        ...
        public Geom2dGcc_Circ2dTanOnRadGeo(Geom2dGcc_QCurve Qualified1, Geom2dAdaptor_Curve OnCurv, double Radius,
            double Tolerance)
            : base()
        {
            throw new NotImplementedException();
