...
namespace CascadeSharp.TKGeomAlgo.Geom2dGcc
{
    ...
    public sealed class Geom2dGcc_FunctionTanCuCu : math_FunctionSetWithDerivatives
    {
        ...
        public void InitDerivative(Vector X, gp_Pnt2d Point1, gp_Pnt2d Point2, gp_Vec2d Tan1, gp_Vec2d Tan2,
        ...
        public bool Derivatives(Vector X, math_Matrix Deriv)
        {
            throw new NotImplementedException();
        }

        public bool Values(Vector X, Vector F, math_Matrix Deriv)
        {
            throw new NotImplementedException();
        }
    }; // class Geom2dGcc_FunctionTanCuCu
