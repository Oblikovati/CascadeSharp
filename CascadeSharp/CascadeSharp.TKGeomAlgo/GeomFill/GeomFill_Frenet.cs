...
namespace CascadeSharp.TKGeomAlgo.GeomFill
{
    ...
    //---------------------------------------------------------------------
    public sealed class GeomFill_Frenet : GeomFill_TrihedronLaw
    {
        ...
        public bool DoSingular(double U, int Index, gp_Vec Tangent, gp_Vec BiNormal, ref int n, ref int k,
            ref int TFlag, ref int BNFlag, ref double Delta)
        {
            throw new NotImplementedException();
        }

        public bool SingularD0(double Param, int Index, gp_Vec Tangent, gp_Vec Normal, gp_Vec BiNormal,
            ref double Delta)
        {
            throw new NotImplementedException();
        }

        public bool SingularD1(double Param, int Index, gp_Vec Tangent, gp_Vec DTangent, gp_Vec Normal, gp_Vec DNormal,
            gp_Vec BiNormal, gp_Vec DBiNormal, ref double Delta)
        {
            throw new NotImplementedException();
        }

        public bool SingularD2(double Param, int Index, gp_Vec Tangent, gp_Vec DTangent, gp_Vec D2Tangent,
            gp_Vec Normal, gp_Vec DNormal, gp_Vec D2Normal, gp_Vec BiNormal, gp_Vec DBiNormal, gp_Vec D2BiNormal,
            ref double Delta)
        {
            throw new NotImplementedException();
        }
