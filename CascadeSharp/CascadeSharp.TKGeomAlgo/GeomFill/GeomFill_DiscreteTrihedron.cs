...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class GeomFill_DiscreteTrihedron : CascadeSharp.GeomFill_TrihedronLaw
	{

		public GeomFill_DiscreteTrihedron()
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_DiscreteTrihedron(GeomFill_DiscreteTrihedron parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
