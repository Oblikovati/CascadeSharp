...
namespace CascadeSharp.TKGeomAlgo.GeomFill
{
    ...
    public sealed class GeomFill
    {
        ...
        public void GetShape(double MaxAng, ref int NbPoles, ref int NbKnots, ref int Degree,
            ref Convert_ParameterisationType TypeConv)
        {
            throw new NotImplementedException();
        }
        ...
        public void GetMinimalWeights(Convert_ParameterisationType TConv, double AngleMin, double AngleMax,
