...
namespace CascadeSharp.TKGeomAlgo.GeomFill
{
    ...
    public sealed class GeomFill_SweepSectionGenerator
    {
        ...
        public GeomFill_SweepSectionGenerator(Adaptor3d_HCurve Path, Adaptor3d_HCurve Curve1, Adaptor3d_HCurve Curve2,
            double Radius)
            : base()
        {
            throw new NotImplementedException();
        ...
        public bool Section(int P, TColgp_Array1OfPnt Poles, TColgp_Array1OfVec DPoles, TColgp_Array1OfPnt2d Poles2d,
            TColgp_Array1OfVec2d DPoles2d, TColStd_Array1OfReal Weigths, TColStd_Array1OfReal DWeigths)
        {
            throw new NotImplementedException();
        }
