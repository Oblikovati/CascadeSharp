...
namespace CascadeSharp.TKGeomAlgo.GeomFill
{
    ...
    {
        public GeomFill_CircularBlendFunc(Adaptor3d_HCurve Path, Adaptor3d_HCurve Curve1, Adaptor3d_HCurve Curve2,
            double Radius, bool Polynomial)
            : base()
        {
        ...
        public bool D0(double Param, double First, double Last, TColgp_Array1OfPnt Poles, TColgp_Array1OfPnt2d Poles2d,
            TColStd_Array1OfReal Weigths)
        {
            throw new NotImplementedException();
        }

        public bool D1(double Param, double First, double Last, TColgp_Array1OfPnt Poles, TColgp_Array1OfVec DPoles,
