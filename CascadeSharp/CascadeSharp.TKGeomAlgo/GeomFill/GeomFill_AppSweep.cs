...
namespace CascadeSharp.TKGeomAlgo.GeomFill
{
	...
	public  sealed class GeomFill_AppSweep : AppBlend_Approx
	{
		...
		public GeomFill_AppSweep(int Degmin, int Degmax, double Tol3d, double Tol2d, int NbIt, bool KnownParameters)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_AppSweep(int Degmin, int Degmax, double Tol3d, double Tol2d, int NbIt)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_AppSweep(GeomFill_AppSweep parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Perform(GeomFill_Line Lin, GeomFill_SweepSectionGenerator SecGen)
		{
			throw new NotImplementedException();
		}
		...
		public void InternalPerform(GeomFill_Line Lin, GeomFill_SweepSectionGenerator SecGen, bool SpApprox, bool UseVariational)
		{
			throw new NotImplementedException();
		}
