...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class GeomFill_NSections : CascadeSharp.GeomFill_SectionLaw
	{
		...
		public GeomFill_NSections(TColGeom_SequenceOfCurve NC, TColStd_SequenceOfReal NP)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public GeomFill_NSections(TColGeom_SequenceOfCurve NC, TColStd_SequenceOfReal NP, double UF, double UL, double VF, double VL)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_NSections(TColGeom_SequenceOfCurve NC, GeomFill_SequenceOfTrsf Trsfs, TColStd_SequenceOfReal NP, double UF, double UL, double VF, double VL, Geom_BSplineSurface Surf)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_NSections(GeomFill_NSections parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomFill_NSections()
		{
			throw new NotImplementedException();
		}
		...
		public void SetSurface(Geom_BSplineSurface RefSurf)
		{
			throw new NotImplementedException();
		}
