...
namespace CascadeSharp.TKGeomAlgo.GccAna
{
	...
	public  sealed class GccAna_Circ2d2TanOn
	{
		...
		public GccAna_Circ2d2TanOn(GccEnt_QualifiedCirc Qualified1, GccEnt_QualifiedCirc Qualified2, gp_Lin2d OnLine, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}

		public GccAna_Circ2d2TanOn(GccEnt_QualifiedCirc Qualified1, GccEnt_QualifiedLin Qualified2, gp_Lin2d OnLine, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}

		public GccAna_Circ2d2TanOn(GccEnt_QualifiedLin Qualified1, GccEnt_QualifiedLin Qualified2, gp_Lin2d OnLine, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public GccAna_Circ2d2TanOn(GccEnt_QualifiedCirc Qualified1, GccEnt_QualifiedCirc Qualified2, gp_Circ2d OnCirc, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}

		public GccAna_Circ2d2TanOn(GccEnt_QualifiedCirc Qualified1, GccEnt_QualifiedLin Qualified2, gp_Circ2d OnCirc, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public GccAna_Circ2d2TanOn(GccEnt_QualifiedLin Qualified1, GccEnt_QualifiedLin Qualified2, gp_Circ2d OnCirc, double Tolerance)
			: base()
		{
			throw new NotImplementedException();
		}
