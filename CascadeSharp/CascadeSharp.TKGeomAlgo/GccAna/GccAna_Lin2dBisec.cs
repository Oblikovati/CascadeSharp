...
namespace CascadeSharp.TKGeomAlgo.GccAna
{
    ...
    //---------------------------------------------------------------------
    public sealed class GccAna_Lin2dBisec
    {
        public GccAna_Lin2dBisec(gp_Lin2d Lin1, gp_Lin2d Lin2)
            : base()
        {
            throw new NotImplementedException();
        }

        public GccAna_Lin2dBisec(GccAna_Lin2dBisec parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public GccAna_Lin2dBisec()
        {
            throw new NotImplementedException();
        }
