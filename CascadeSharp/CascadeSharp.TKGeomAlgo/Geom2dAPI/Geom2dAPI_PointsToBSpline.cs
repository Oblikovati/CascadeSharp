...
namespace CascadeSharp.TKGeomAlgo.Geom2dAPI
{
    ...
    //---------------------------------------------------------------------
    public sealed class Geom2dAPI_PointsToBSpline
    {
        ...
        public Geom2dAPI_PointsToBSpline(TColgp_Array1OfPnt2d Points, Approx_ParametrizationType ParType, int DegMin,
            int DegMax, GeomAbs_Shape Continuity, double Tol2D)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public Geom2dAPI_PointsToBSpline(Geom2dAPI_PointsToBSpline parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
