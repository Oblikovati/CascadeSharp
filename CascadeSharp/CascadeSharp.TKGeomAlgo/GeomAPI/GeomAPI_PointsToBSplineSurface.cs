...
namespace CascadeSharp.TKGeomAlgo.GeomAPI
{
    ...
    public sealed class GeomAPI_PointsToBSplineSurface
    {
        ...
        public GeomAPI_PointsToBSplineSurface(TColStd_Array2OfReal ZPoints, double X0, double dX, double Y0, double dY,
            int DegMin, int DegMax, GeomAbs_Shape Continuity, double Tol3D)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public GeomAPI_PointsToBSplineSurface(TColStd_Array2OfReal ZPoints, double X0, double dX, double Y0, double dY,
            int DegMin, int DegMax, GeomAbs_Shape Continuity)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void Interpolate(TColgp_Array2OfPnt Points, Approx_ParametrizationType ParType, bool thePeriodic)
        {
            throw new NotImplementedException();
        }
        ...
        public void Init(TColgp_Array2OfPnt Points, Approx_ParametrizationType ParType, int DegMin, int DegMax,
            GeomAbs_Shape Continuity, double Tol3D, bool thePeriodic)
        {
            throw new NotImplementedException();
        }
