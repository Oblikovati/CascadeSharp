...
using CascadeSharp.TKGeomBase.Extrema;
...
namespace CascadeSharp.TKGeomAlgo.GeomAPI
{
    ...
    //---------------------------------------------------------------------
    public sealed class GeomAPI_ProjectPointOnCurve
    {
        ...
        public GeomAPI_ProjectPointOnCurve(GeomAPI_ProjectPointOnCurve parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
