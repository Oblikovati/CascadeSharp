...
namespace CascadeSharp.TKGeomAlgo.IntPatch
{
    ...
    public sealed class IntPatch_Intersection
    {
        ...
        public IntPatch_Intersection(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, double TolArc, double TolTang)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, double TolArc, double TolTang, bool _isGeomInt, bool theIsReqToKeepRLine,
            bool theIsReqToPostWLProc)
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, double TolArc, double TolTang, bool _isGeomInt)
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            ...
            bool theIsReqToKeepRLine, bool theIsReqToPostWLProc)
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, double U1, double V1, double U2, double V2, double TolArc, double TolTang)
        {
            throw new NotImplementedException();
        }
        ...
        public void Dump(int Mode, Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2)
        {
            throw new NotImplementedException();
        }
        ...
        public void GeomParamPerfom(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, bool _isNotAnalitical, GeomAbs_SurfaceType typs1, GeomAbs_SurfaceType typs2)
        {
            throw new NotImplementedException();
        }
    }; // class IntPatch_Intersection
