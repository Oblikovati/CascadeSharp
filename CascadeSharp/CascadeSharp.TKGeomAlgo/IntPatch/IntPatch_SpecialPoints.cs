...
namespace CascadeSharp.TKGeomAlgo.IntPatch
{
    ...
    public sealed class IntPatch_SpecialPoints
    {
        ...
        public bool AddCrossUVIsoPoint(Adaptor3d_HSurface theQSurf, Adaptor3d_HSurface thePSurf,
            IntSurf_PntOn2S theRefPt, double theTol3d, IntSurf_PntOn2S theAddedPoint, bool theIsReversed)
        {
            throw new NotImplementedException();
        }
        ...
        public bool AddSingularPole(Adaptor3d_HSurface theQSurf, Adaptor3d_HSurface thePSurf, IntSurf_PntOn2S thePtIso,
            IntPatch_Point theVertex, IntSurf_PntOn2S theAddedPoint, bool theIsReversed, bool theIsReqRefCheck)
        {
            throw new NotImplementedException();
        }

        public bool AddSingularPole(Adaptor3d_HSurface theQSurf, Adaptor3d_HSurface thePSurf, IntSurf_PntOn2S thePtIso,
            IntPatch_Point theVertex, IntSurf_PntOn2S theAddedPoint, bool theIsReversed)
        {
            throw new NotImplementedException();
        }
