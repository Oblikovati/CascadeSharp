...
namespace CascadeSharp.TKGeomAlgo.IntPatch
{
    ...
    public sealed class IntPatch_ImpImpIntersection
    {
        ...
        public IntPatch_ImpImpIntersection(Adaptor3d_HSurface S1, Adaptor3d_TopolTool D1, Adaptor3d_HSurface S2,
            Adaptor3d_TopolTool D2, double TolArc, double TolTang, bool theIsReqToKeepRLine)
            : base()
        {
            throw new NotImplementedException();
        }
