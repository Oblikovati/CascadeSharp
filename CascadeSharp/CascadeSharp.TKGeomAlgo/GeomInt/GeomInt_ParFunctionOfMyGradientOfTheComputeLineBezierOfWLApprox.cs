...
namespace CascadeSharp.TKGeomAlgo.GeomInt
{
    ...
    //---------------------------------------------------------------------
    public sealed class
        GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox : math_MultipleVarFunctionWithGradient
    {
        ...
        public GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox(
            GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
