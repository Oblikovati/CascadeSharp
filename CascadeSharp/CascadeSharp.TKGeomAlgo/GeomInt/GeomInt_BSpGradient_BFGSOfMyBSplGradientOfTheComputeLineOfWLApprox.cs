...
namespace CascadeSharp.TKGeomAlgo.GeomInt
{
	...
	public  sealed class GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox : math_BFGS
	{
		...
		public GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox(math_MultipleVarFunctionWithGradient F, math_Vector StartingPoint, double Tolerance3d, double Tolerance2d, double Eps)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
