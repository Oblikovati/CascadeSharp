...
namespace CascadeSharp
{
	...
	public  sealed class GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox
	{
		...
		public GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}
