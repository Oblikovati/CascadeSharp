...
namespace CascadeSharp.TKGeomAlgo.GeomInt
{
	...
	//---------------------------------------------------------------------
	public  sealed class GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox
	{

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_TheMultiLineOfWLApprox SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox(GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox()
		{
			throw new NotImplementedException();
		}
		...
		public void Affect(GeomInt_TheMultiLineOfWLApprox SSP, int Index,  ref AppParCurves_Constraint Cons, math_Vector Vt, math_Vector Vc)
		{
			throw new NotImplementedException();
		}
