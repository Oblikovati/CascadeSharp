...
namespace CascadeSharp.TKGeomAlgo.GeomInt
{
    ...
    public sealed class GeomInt_IntSS
    {
        ...
        public void Perform(Geom_Surface S1, Geom_Surface S2, double Tol, double U1, double V1, double U2, double V2,
            bool Approx, bool ApproxS1, bool ApproxS2)
        {
            throw new NotImplementedException();
        }

        public void Perform(Geom_Surface S1, Geom_Surface S2, double Tol, double U1, double V1, double U2, double V2,
            bool Approx, bool ApproxS1)
        {
            throw new NotImplementedException();
        }
        ...
        public void Perform(GeomAdaptor_HSurface HS1, GeomAdaptor_HSurface HS2, double Tol, double U1, double V1,
            double U2, double V2, bool Approx, bool ApproxS1, bool ApproxS2)
        {
            throw new NotImplementedException();
        }

        public void Perform(GeomAdaptor_HSurface HS1, GeomAdaptor_HSurface HS2, double Tol, double U1, double V1,
            double U2, double V2, bool Approx, bool ApproxS1)
        {
            throw new NotImplementedException();
        }
        ...
        public void InternalPerform(double Tol, bool Approx, bool ApproxS1, bool ApproxS2, bool useStart, double U1,
            double V1, double U2, double V2)
        {
            throw new NotImplementedException();
        }

        public void MakeCurve(int Ind, Adaptor3d_TopolTool D1, Adaptor3d_TopolTool D2, double Tol, bool Approx,
            bool Approx1, bool Approx2)
        {
            throw new NotImplementedException();
        }
    }; // class GeomInt_IntSS
