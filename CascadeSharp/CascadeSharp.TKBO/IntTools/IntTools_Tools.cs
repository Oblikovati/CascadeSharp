...
namespace CascadeSharp.TKBO.IntTools
{
    ...
    public sealed class IntTools_Tools
    {
        ...
        public TopAbs_State ClassifyPointByFace(TopoDS_Face aF, gp_Pnt2d P)
        {
            throw new NotImplementedException();
        }
        ...
        public bool ComputeTolerance(Geom_Curve theCurve3D, Geom2d_Curve theCurve2D, Geom_Surface theSurf,
            double theFirst, double theLast, ref double theMaxD_ist, ref double theMaxPar, double theTolRange)
        {
            throw new NotImplementedException();
        }

        public bool ComputeTolerance(Geom_Curve theCurve3D, Geom2d_Curve theCurve2D, Geom_Surface theSurf,
            double theFirst, double theLast, ref double theMaxD_ist, ref double theMaxPar)
        {
            throw new NotImplementedException();
        }
