...
namespace CascadeSharp
{
	...
	public  sealed class IntTools_Context : Standard_Transient
	{
		...
		public int ComputeVF(TopoDS_Vertex theVertex, TopoDS_Face theFace, ref double theU, ref double theV, ref double theTol, double theFuzz)
		{
			throw new NotImplementedException();
		}

		public int ComputeVF(TopoDS_Vertex theVertex, TopoDS_Face theFace, ref double theU, ref double theV, ref double theTol)
		{
			throw new NotImplementedException();
		}
		...
		public bool IsValidBlockForFaces(double aT1, double aT2, IntTools_Curve aIC, TopoDS_Face aF1, TopoDS_Face aF2, double aTol)
		{
			throw new NotImplementedException();
		}
