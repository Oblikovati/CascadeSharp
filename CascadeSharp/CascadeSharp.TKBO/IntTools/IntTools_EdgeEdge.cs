...
namespace CascadeSharp.TKBO.IntTools
{
    ...
    public sealed class IntTools_EdgeEdge
    {
        ...
        public IntTools_EdgeEdge(TopoDS_Edge theEdge1, double aT11, double aT12, TopoDS_Edge theEdge2, double aT21,
            double aT22)
            : base()
        {
            throw new NotImplementedException();
        ...
        public void FindSolutions(IntTools_SequenceOfRanges theRanges1, IntTools_SequenceOfRanges theRanges2,
            ref bool bSplit2)
        {
            throw new NotImplementedException();
        }
        ...
        public int CheckCoincidence(double aT11, double aT12, double aT21, double aT22, double theCriteria,
            double theCurveRes1)
        {
            throw new NotImplementedException();
        }
