...
namespace CascadeSharp.TKBO.IntTools
{
	...
	//---------------------------------------------------------------------
	public  sealed class IntTools_Curve
	{
		...
		public bool Bounds(ref double theFirst, ref double theLast, gp_Pnt theFirstPnt, gp_Pnt theLastPnt)
		{
			throw new NotImplementedException();
		}

		public bool D0(double thePar, gp_Pnt thePnt)
		{
			throw new NotImplementedException();
		}
