...
namespace CascadeSharp.TKBO.BOPTools
{
    ...
    public sealed class BOPTools_AlgoTools
    {
        ...
        public void MakeEdge(IntTools_Curve theCurve, TopoDS_Vertex theV1, double theT1, TopoDS_Vertex theV2,
            double theT2, double theTolR3D, TopoDS_Edge theE)
        {
            throw new NotImplementedException();
        }
        ...
        public void MakeSplitEdge(TopoDS_Edge aE1, TopoDS_Vertex aV1, double aP1, TopoDS_Vertex aV2, double aP2,
            TopoDS_Edge aNewEdge)
        {
            throw new NotImplementedException();
        }

        public void MakeSectEdge(IntTools_Curve aIC, TopoDS_Vertex aV1, double aP1, TopoDS_Vertex aV2, double aP2,
            TopoDS_Edge aNewEdge)
        {
            throw new NotImplementedException();
        }

        public TopAbs_State ComputeState(gp_Pnt thePoint, TopoDS_Solid theSolid, double theTol,
            IntTools_Context theContext)
        {
            throw new NotImplementedException();
        }

        public TopAbs_State ComputeState(TopoDS_Vertex theVertex, TopoDS_Solid theSolid, double theTol,
            IntTools_Context theContext)
        {
            throw new NotImplementedException();
        }
        ...
        public int IsInternalFace(TopoDS_Face theFace, TopoDS_Edge theEdge, TopoDS_Face theFace1, TopoDS_Face theFace2,
            IntTools_Context theContext)
        {
            throw new NotImplementedException();
        }
        ...
        public void MakeConnexityBlock(TopTools_ListOfShape theLS, TopTools_IndexedMapOfShape theMapAvoid,
            TopTools_ListOfShape theLSCB, NCollection_BaseAllocator theAllocator)
        {
            throw new NotImplementedException();
        }

        public void MakeConnexityBlocks(TopoDS_Shape theS, TopAbs_ShapeEnum theConnectionType,
            TopAbs_ShapeEnum theElementType, TopTools_ListOfShape theLCB)
        {
            throw new NotImplementedException();
        }
        ...
        public bool ComputeTolerance(TopoDS_Face theFace, TopoDS_Edge theEdge, ref double theMaxD_ist,
            ref double theMaxPar)
        {
            throw new NotImplementedException();
        }
