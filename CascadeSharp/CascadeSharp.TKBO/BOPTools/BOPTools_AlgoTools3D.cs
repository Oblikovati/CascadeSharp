...
namespace CascadeSharp.TKBO.BOPTools
{
	...
	public  sealed class BOPTools_AlgoTools3D
	{
		...
		public void GetNormalToFaceOnEdge(TopoDS_Edge aE, TopoDS_Face aF, double aT, gp_Dir aD, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}
		...
		public bool GetApproxNormalToFaceOnEdge(TopoDS_Edge aE, TopoDS_Face aF, double aT, gp_Pnt aPx, gp_Dir aD, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}

		public bool GetApproxNormalToFaceOnEdge(TopoDS_Edge theE, TopoDS_Face theF, double aT, gp_Pnt aP, gp_Dir aDNF, double aDt2D)
		{
			throw new NotImplementedException();
		}

		public bool GetApproxNormalToFaceOnEdge(TopoDS_Edge theE, TopoDS_Face theF, double aT, double aDt2D, gp_Pnt aP, gp_Dir aDNF, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}

		public int PointNearEdge(TopoDS_Edge aE, TopoDS_Face aF, double aT, double aDt2D, gp_Pnt2d aP2D, gp_Pnt aPx, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}
		...
		public int PointNearEdge(TopoDS_Edge aE, TopoDS_Face aF, double aT, gp_Pnt2d aP2D, gp_Pnt aPx, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}
		...
		public int PointInFace(TopoDS_Face theF, TopoDS_Edge theE, double theT, double theDt2D, gp_Pnt theP, gp_Pnt2d theP2D, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}

		public int PointInFace(TopoDS_Face theF, Geom2d_Curve theL, gp_Pnt theP, gp_Pnt2d theP2D, IntTools_Context theContext, double theDt2D)
		{
			throw new NotImplementedException();
		}

		public int PointInFace(TopoDS_Face theF, Geom2d_Curve theL, gp_Pnt theP, gp_Pnt2d theP2D, IntTools_Context theContext)
		{
			throw new NotImplementedException();
		}
