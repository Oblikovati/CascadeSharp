...
namespace CascadeSharp.TKBO.BOPDS
{
    ...
    //---------------------------------------------------------------------
    public sealed class BOPDS_MapOfPaveBlock
    {
        ...
        public bool Contains(BOPDS_PaveBlock K)
        {
            throw new NotImplementedException();
        }

        public bool Remove(BOPDS_PaveBlock K)
        {
            throw new NotImplementedException();
        }
        ...
        public bool IsEqual(BOPDS_MapOfPaveBlock theOther)
        {
            throw new NotImplementedException();
        }

        public bool Contains(BOPDS_MapOfPaveBlock theOther)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Intersect(BOPDS_MapOfPaveBlock theOther)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Subtract(BOPDS_MapOfPaveBlock theOther)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Differ(BOPDS_MapOfPaveBlock theOther)
        {
            throw new NotImplementedException();
        }
    }; // class BOPDS_MapOfPaveBlock
