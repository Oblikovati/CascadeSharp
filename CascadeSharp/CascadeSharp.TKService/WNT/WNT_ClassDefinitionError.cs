...
namespace CascadeSharp.TKService.WNT
{
    ...
    public sealed class WNT_ClassDefinitionError : Standard_ConstructionError
    {
        ...
        public WNT_ClassDefinitionError(string theMessage)
            : base()
        {
            throw new NotImplementedException();
        }

        public WNT_ClassDefinitionError(WNT_ClassDefinitionError parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public WNT_ClassDefinitionError NewInstance(string theMessage)
        {
            throw new NotImplementedException();
        }

        public WNT_ClassDefinitionError NewInstance()
        {
            throw new NotImplementedException();
        }
