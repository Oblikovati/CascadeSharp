...
namespace CascadeSharp.TKBool.BRepAlgo
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepAlgo_Image
	{
		...
		public BRepAlgo_Image(BRepAlgo_Image parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void RemoveRoot(TopoDS_Shape Root)
		{
			throw new NotImplementedException();
		}

		public void ReplaceRoot(TopoDS_Shape OldRoot, TopoDS_Shape NewRoot)
		{
			throw new NotImplementedException();
		}
		...
		public bool IsImage(TopoDS_Shape S)
		{
			throw new NotImplementedException();
		}
		...
		public bool HasImage(TopoDS_Shape S)
		{
			throw new NotImplementedException();
		}
