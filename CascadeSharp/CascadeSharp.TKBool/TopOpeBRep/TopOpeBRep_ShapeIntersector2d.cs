...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class TopOpeBRep_ShapeIntersector2d
	{

		public TopOpeBRep_ShapeIntersector2d()
			: base()
		{
			throw new NotImplementedException();
		}

		public TopOpeBRep_ShapeIntersector2d(TopOpeBRep_ShapeIntersector2d parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
