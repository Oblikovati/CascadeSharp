...
namespace CascadeSharp.TKBool.TopOpeBRep
{
    ...
    public sealed class TopOpeBRep_FFTransitionTool
    {
        ...
        public TopOpeBRepDS_Transition ProcessLineTransition(TopOpeBRep_VPointInter P, int Index,
            TopAbs_Orientation EdgeOrientation)
        {
            throw new NotImplementedException();
        }
        ...
        public TopOpeBRepDS_Transition ProcessEdgeONTransition(TopOpeBRep_VPointInter VP, int Index, TopoDS_Shape R,
            TopoDS_Shape E, TopoDS_Shape F)
        {
            throw new NotImplementedException();
        }
    }; // class TopOpeBRep_FFTransitionTool
