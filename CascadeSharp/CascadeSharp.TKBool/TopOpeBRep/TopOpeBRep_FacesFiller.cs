...
namespace CascadeSharp.TKBool.TopOpeBRep
{
    ...
    public sealed class TopOpeBRep_FacesFiller
    {
        ...
        public void Insert(TopoDS_Shape F1, TopoDS_Shape F2, TopOpeBRep_FacesIntersector FACINT,
        ...
        public void ProcessVPIonR(TopOpeBRep_VPointInterIterator VPI, TopOpeBRepDS_Transition trans1, TopoDS_Shape F1,
            int ShapeIndex)
        {
            throw new NotImplementedException();
        }

        public void ProcessVPonR(TopOpeBRep_VPointInter VP, TopOpeBRepDS_Transition trans1, TopoDS_Shape F1,
            int ShapeIndex)
        {
            throw new NotImplementedException();
        }

        public void ProcessVPonclosingR(TopOpeBRep_VPointInter VP, TopoDS_Shape F1, int ShapeIndex,
            TopOpeBRepDS_Transition transEdge, TopOpeBRepDS_Kind PVKind, int PVIndex, bool EPIfound,
            TopOpeBRepDS_Interference IEPI)
        {
            throw new NotImplementedException();
        }

        public bool ProcessVPondgE(TopOpeBRep_VPointInter VP, int ShapeIndex, ref TopOpeBRepDS_Kind PVKind,
            ref int PVIndex, ref bool EPIfound, TopOpeBRepDS_Interference IEPI, ref bool CPIfound,
            TopOpeBRepDS_Interference ICPI)
        {
            throw new NotImplementedException();
        }
        ...
        public TopOpeBRepDS_Transition GetEdgeTrans(TopOpeBRep_VPointInter VP, TopOpeBRepDS_Kind PVKind, int PVIndex,
            int Sind, TopoDS_Face F)
        {
            throw new NotImplementedException();
        }
        ...
        public TopAbs_State StBipVPonF(TopOpeBRep_VPointInter IVPf, TopOpeBRep_VPointInter IVPl,
            TopOpeBRep_LineInter Lrest, bool _isonedge1)
        {
            throw new NotImplementedException();
        }
    }; // class TopOpeBRep_FacesFiller
