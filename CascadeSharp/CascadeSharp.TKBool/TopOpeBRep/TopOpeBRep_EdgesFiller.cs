...
namespace CascadeSharp.TKBool.TopOpeBRep
{
	...
	public  sealed class TopOpeBRep_EdgesFiller
	{
		...
		public void Insert(TopoDS_Shape E1, TopoDS_Shape E2, TopOpeBRep_EdgesIntersector EI, TopOpeBRepDS_HDataStructure HDS)
		{
			throw new NotImplementedException();
		}
		...
		public TopOpeBRepDS_Interference StorePI(TopOpeBRep_Point2d P, TopOpeBRepDS_Transition T, int EI, int PI, double p, int IE)
		{
			throw new NotImplementedException();
		}
