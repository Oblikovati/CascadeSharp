...
namespace CascadeSharp.TKBool.TopOpeBRepDS
{
    ...
    public sealed class TopOpeBRepDS_DataStructure
    {
        ...
        public void FillShapesSameDomain(TopoDS_Shape S1, TopoDS_Shape S2, TopOpeBRepDS_Config c1,
            TopOpeBRepDS_Config c2, bool _refFirst)
        {
            throw new NotImplementedException();
        }

        public void FillShapesSameDomain(TopoDS_Shape S1, TopoDS_Shape S2, TopOpeBRepDS_Config c1,
            TopOpeBRepDS_Config c2)
        {
            throw new NotImplementedException();
        }
        ...
        public TopOpeBRepDS_IndexedDataMapOfShapeWithState ChangeMapOfShapeWithState(TopoDS_Shape aShape,
            ref bool aFlag)
        {
            throw new NotImplementedException();
        }
