...
namespace CascadeSharp.TKBool.TopOpeBRepDS
{
	...
	//---------------------------------------------------------------------
	public  sealed class TopOpeBRepDS_Transition
	{

		public TopOpeBRepDS_Transition()
			: base()
		{
		...
		public TopOpeBRepDS_Transition(TopOpeBRepDS_Transition parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void IndexBefore(int I)
		{
			throw new NotImplementedException();
		}

		public void IndexAfter(int I)
		{
			throw new NotImplementedException();
		}
		...
		public TopOpeBRepDS_Transition Complement()
		{
			throw new NotImplementedException();
		}
