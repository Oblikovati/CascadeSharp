...
namespace CascadeSharp.TKBool.TopOpeBRepDS
{
	...
	public  sealed class TopOpeBRepDS_BuildTool
	{
		...
		public void GetOrientedEdgeVertices(TopoDS_Edge E, TopoDS_Vertex Vmin, TopoDS_Vertex Vmax, ref double Parmin, ref double Parmax)
		{
			throw new NotImplementedException();
		}

		public void UpdateEdgeCurveTol(TopoDS_Face F1, TopoDS_Face F2, TopoDS_Edge E, Geom_Curve C3Dnew, double tol3d, double tol2d1, double tol2d2, ref double newtol, ref double newparmin, ref double newparmax)
		{
			throw new NotImplementedException();
		}
		...
		public void ComputePCurves(TopOpeBRepDS_Curve C, TopoDS_Edge E, TopOpeBRepDS_Curve newC, bool CompPC1, bool CompPC2, bool CompC3D)
		{
			throw new NotImplementedException();
		}
		...
		public void RecomputeCurves(TopOpeBRepDS_Curve C, TopoDS_Edge oldE, TopoDS_Edge E, ref int inewC, TopOpeBRepDS_HDataStructure HDS)
		{
			throw new NotImplementedException();
		}
