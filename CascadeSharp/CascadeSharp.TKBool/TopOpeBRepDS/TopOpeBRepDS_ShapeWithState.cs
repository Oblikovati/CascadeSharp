...
namespace CascadeSharp.TKBool.TopOpeBRepDS
{
    ...
    //---------------------------------------------------------------------
    public sealed class TopOpeBRepDS_ShapeWithState
    {
        public TopOpeBRepDS_ShapeWithState()
            : base()
        {
            throw new NotImplementedException();
        }

        public TopOpeBRepDS_ShapeWithState(TopOpeBRepDS_ShapeWithState parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void SetIsSplitted(bool anIsSplitted)
        {
            throw new NotImplementedException();
        }
