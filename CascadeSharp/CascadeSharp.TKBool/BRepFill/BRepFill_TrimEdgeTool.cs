...
namespace CascadeSharp.TKBool.BRepFill
{
    ...
    public sealed class BRepFill_TrimEdgeTool
    {
        ...
        public void IntersectWith(TopoDS_Edge Edge1, TopoDS_Edge Edge2, TopoDS_Shape InitShape1,
            TopoDS_Shape InitShape2, TopoDS_Vertex End1, TopoDS_Vertex End2, GeomAbs_JoinType theJoinType,
            bool IsOpenResult, TColgp_SequenceOfPnt Params)
        {
            throw new NotImplementedException();
        }
