...
namespace CascadeSharp
{
	...
	public  sealed class TopOpeBRepBuild_ShellFaceSet : CascadeSharp.TopOpeBRepBuild_ShapeSet
	{
		...
		public TopOpeBRepBuild_ShellFaceSet(TopoDS_Shape S, IntPtr Addr)
			: base()
		{
			throw new NotImplementedException();
		}

		public TopOpeBRepBuild_ShellFaceSet(TopoDS_Shape S)
			: base()
		{
			throw new NotImplementedException();
		}

		public TopOpeBRepBuild_ShellFaceSet(TopOpeBRepBuild_ShellFaceSet parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
