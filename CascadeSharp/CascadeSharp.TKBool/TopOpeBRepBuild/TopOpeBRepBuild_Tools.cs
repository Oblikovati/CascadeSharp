...
namespace CascadeSharp.TKBool.TopOpeBRepBuild
{
    ...
    public sealed class TopOpeBRepBuild_Tools
    {
        ...
        public TopAbs_State FindStateThroughVertex(TopoDS_Shape aShape, TopOpeBRepTool_ShapeClassifier aShapeClassifier,
            TopOpeBRepDS_IndexedDataMapOfShapeWithState aMapOfShapeWithState, TopTools_MapOfShape anAvoidSubshMap)
        {
            throw new NotImplementedException();
        }

        public void PropagateStateForWires(TopTools_IndexedMapOfShape aFacesToRestMap,
        ...
        public bool GetAdjacentFace(TopoDS_Shape aFaceObj, TopoDS_Shape anEObj,
            TopTools_IndexedDataMapOfShapeListOfShape anEdgeFaceMap, TopoDS_Shape anAdjFaceObj)
        {
            throw new NotImplementedException();
        }
        ...
        public bool GetTangentToEdgeEdge(TopoDS_Face aFObj, TopoDS_Edge anEdgeObj, TopoDS_Edge aOriEObj,
            gp_Vec aTangent)
        {
            throw new NotImplementedException();
        }
