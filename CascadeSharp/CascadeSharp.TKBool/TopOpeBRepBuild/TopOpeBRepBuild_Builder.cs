...
namespace CascadeSharp.TKBool.TopOpeBRepBuild
{
	...
	public  class TopOpeBRepBuild_Builder
	{
		...
		public void FillSecEdgeAncestorMap(int aShapeRank, TopTools_MapOfShape aMapON, TopTools_DataMapOfShapeShape anAncMap)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillSolidsSFS(TopTools_ListOfShape LSO1, TopTools_ListOfShape LSO2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_ShellFaceSet SFS)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillSurfaceTopologySFS(TopOpeBRepDS_SurfaceIterator IT, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_ShellFaceSet SFS)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillFaceSFS(TopoDS_Shape F1, TopTools_ListOfShape LSO2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_ShellFaceSet SFS)
		{
			throw new NotImplementedException();
		}

		public void GSplitFaceSFS(TopoDS_Shape F1, TopTools_ListOfShape LSclass, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_ShellFaceSet SFS)
		{
			throw new NotImplementedException();
		}
		...
		public void FillOnPatches(TopTools_ListOfShape anEdgesON, TopoDS_Shape aBaseFace, TopTools_IndexedMapOfOrientedShape avoidMap)
		{
			throw new NotImplementedException();
		}

		public void FindFacesTouchingEdge(TopoDS_Shape aFace, TopoDS_Shape anEdge, int aShRank, TopTools_ListOfShape aFaces)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillFacesWES(TopTools_ListOfShape LF1, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}

		public void GFillFacesWESK(TopTools_ListOfShape LF1, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES, int K)
		{
			throw new NotImplementedException();
		}

		public void GFillFacesWESMakeFaces(TopTools_ListOfShape LF1, TopTools_ListOfShape LF2, TopTools_ListOfShape LSO, TopOpeBRepBuild_GTopo G)
		{
			throw new NotImplementedException();
		}

		public void GFillFaceWES(TopoDS_Shape F, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillCurveTopologyWES(TopOpeBRepDS_CurveIterator IT, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}

		public void GFillONPartsWES(TopoDS_Shape F, TopOpeBRepBuild_GTopo G, TopTools_ListOfShape LSclass, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}

		public void GFillWireWES(TopoDS_Shape W, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}

		public void GFillEdgeWES(TopoDS_Shape E, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}

		public void GSplitEdgeWES(TopoDS_Shape E, TopTools_ListOfShape LF2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_WireEdgeSet WES)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillEdgesPVS(TopTools_ListOfShape LE1, TopTools_ListOfShape LE2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_PaveSet PVS)
		{
			throw new NotImplementedException();
		}

		public void GFillEdgePVS(TopoDS_Shape E, TopTools_ListOfShape LE2, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_PaveSet PVS)
		{
			throw new NotImplementedException();
		}
		...
		public void GFillPointTopologyPVS(TopoDS_Shape E, TopOpeBRepDS_PointIterator IT, TopOpeBRepBuild_GTopo G, TopOpeBRepBuild_PaveSet PVS)
		{
			throw new NotImplementedException();
		}
		...
		public void GFABUMakeFaces(TopoDS_Shape FF, TopOpeBRepBuild_FaceBuilder FABU, TopTools_ListOfShape LOF, TopTools_DataMapOfShapeInteger MW_isOld)
		{
			throw new NotImplementedException();
		}
