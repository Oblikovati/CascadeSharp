...
namespace CascadeSharp.TKBool.TopOpeBRepBuild
{
	...
	public  sealed class TopOpeBRepBuild_CorrectFace2d
	{
		...
		public TopOpeBRepBuild_CorrectFace2d(TopoDS_Face aFace, TopTools_IndexedMapOfOrientedShape anAvoidMap, TopTools_IndexedDataMapOfShapeShape aMap)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void TranslateCurve2d(TopoDS_Edge anEdge, TopoDS_Face aFace, gp_Vec2d aTranslateVec, Geom2d_Curve aCurve2d)
		{
			throw new NotImplementedException();
		}
		...
		public void BuildCopyData(TopoDS_Face F, TopTools_IndexedMapOfOrientedShape anAvoidMap, TopoDS_Face aCopyFace, TopTools_IndexedMapOfOrientedShape aCopyAvoidMap, bool aNeedToUsePMap)
		{
			throw new NotImplementedException();
		}

		public int ConnectWire(TopoDS_Face aCopyFace, TopTools_IndexedMapOfOrientedShape aCopyAvoidMap, bool aTryToConnectFlag)
		{
			throw new NotImplementedException();
		}
