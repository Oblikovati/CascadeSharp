...
namespace CascadeSharp.TKBool.TopOpeBRepTool
{
	...
	public  sealed class TopOpeBRepTool_CurveTool
	{
		...
		public bool MakeCurves(double min, double max, Geom_Curve C3D, Geom2d_Curve PC1, Geom2d_Curve PC2, TopoDS_Shape S1, TopoDS_Shape S2, Geom_Curve C3DN, Geom2d_Curve PC1N, Geom2d_Curve PC2N, ref double Tol3d, ref double Tol2d)
		{
			throw new NotImplementedException();
		}
		...
		public Geom2d_Curve MakePCurveOnFace(TopoDS_Shape S, Geom_Curve C, ref double TolReached2d, double first, double last)
		{
			throw new NotImplementedException();
		}
