...
namespace CascadeSharp.TKBool.TopOpeBRepTool
{
    ...
    public sealed class TopOpeBRepTool
    {
        ...
        public bool PurgeClosingEdges(TopoDS_Face F, TopoDS_Face FF, TopTools_DataMapOfShapeInteger MW_isOld,
            TopTools_IndexedMapOfOrientedShape MshNOK)
        {
            throw new NotImplementedException();
        }

        public bool PurgeClosingEdges(TopoDS_Face F, TopTools_ListOfShape LOF, TopTools_DataMapOfShapeInteger MW_isOld,
            TopTools_IndexedMapOfOrientedShape MshNOK)
        {
            throw new NotImplementedException();
        }
        ...
        public bool MakeFaces(TopoDS_Face F, TopTools_ListOfShape LOF, TopTools_IndexedMapOfOrientedShape MshNOK,
            TopTools_ListOfShape LOFF)
        {
            throw new NotImplementedException();
        }

        public bool Regularize(TopoDS_Face aFace, TopTools_ListOfShape aL_istOfFaces,
