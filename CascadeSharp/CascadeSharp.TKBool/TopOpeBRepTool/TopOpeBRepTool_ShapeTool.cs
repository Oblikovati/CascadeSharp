...
namespace CascadeSharp.TKBool.TopOpeBRepTool
{
    ...
    public sealed class TopOpeBRepTool_ShapeTool
    {
        ...
        public void UVBOUNDS(Geom_Surface S, ref bool UPeri, ref bool VPeri, ref double Umin, ref double Umax,
            ref double Vmin, ref double Vmax)
        {
            throw new NotImplementedException();
        }

        public void UVBOUNDS(TopoDS_Face F, ref bool UPeri, ref bool VPeri, ref double Umin, ref double Umax,
            ref double Vmin, ref double Vmax)
        {
            throw new NotImplementedException();
        }
