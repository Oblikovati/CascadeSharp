...
namespace CascadeSharp.TKV3d.AIS
{
	...
	public  class AIS_ViewCube : AIS_InteractiveObject
	{
		...
		public void SetAxesLabels(TCollection_AsciiString theX, TCollection_AsciiString theY, TCollection_AsciiString theZ)
		{
			throw new NotImplementedException();
		}
		...
		public void createRoundRectangleTriangles(Graphic3d_ArrayOfTriangles theTr_is, ref int theNbNodes, ref int theNbTr_is, gp_XY theSize, double theRadius, gp_Trsf theTrsf)
		{
			throw new NotImplementedException();
		}
