...
namespace CascadeSharp.TKV3d.Prs3d
{
    ...
    {
        public Prs3d_ToolCylinder(double theBottomRad, double theTopRad, double theHeight, int theNbSlices,
            int theNbStacks)
            : base()
        {
        ...
        public Graphic3d_ArrayOfTriangles Create(double theBottomRad, double theTopRad, double theHeight,
