...
namespace CascadeSharp.TKV3d.Prs3d
{
    ...
    public sealed class Prs3d_Arrow
    {
        ...
        public Graphic3d_ArrayOfTriangles DrawShaded(gp_Ax1 theAx_is, double theTubeRadius, double theAx_isLength,
            double theConeRadius, double theConeLength, int theNbFacettes)
        {
            throw new NotImplementedException();
        }
