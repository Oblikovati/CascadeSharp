...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class Prs3d_ToolDisk : CascadeSharp.Prs3d_ToolQuadric
	{
		...
		public Graphic3d_ArrayOfTriangles Create(double theInnerRadius, double theOuterRadius, int theNbSlices, int theNbStacks, gp_Trsf theTrsf)
		{
			throw new NotImplementedException();
		}
