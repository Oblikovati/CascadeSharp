...
namespace CascadeSharp.TKV3d.V3d
{
    ...
    public sealed class V3d_View : Standard_Transient
    {
        ...
        public void SetBgGradientColors(Quantity_Color theColor1, Quantity_Color theColor2,
            Aspect_GradientFillMethod theFillStyle, bool theToUpdate)
        {
            throw new NotImplementedException();
        }
        ...
        public void ZBufferTriedronSetup(Quantity_Color theXColor, Quantity_Color theYColor, Quantity_Color theZColor,
            double theSizeRatio, double theAx_isDiametr, int theNbFacettes)
        {
            throw new NotImplementedException();
        }

        public void ZBufferTriedronSetup(Quantity_Color theXColor, Quantity_Color theYColor, Quantity_Color theZColor,
            double theSizeRatio, double theAx_isDiametr)
        {
            throw new NotImplementedException();
        }
        ...
        public void ConvertWithProj(int Xp, int Yp, ref double X, ref double Y, ref double Z, ref double Vx,
            ref double Vy, ref double Vz)
        {
            throw new NotImplementedException();
        }
        ...
        public void ProjReferenceAxe(int Xpix, int Ypix, ref double XP, ref double YP, ref double ZP, ref double VX,
            ref double VY, ref double VZ)
        {
            throw new NotImplementedException();
        }
        ...
        public void DiagnosticInformation(TColStd_IndexedDataMapOfStringString theDict,
        ...
        public int MinMax(ref double Xmin, ref double Ymin, ref double Zmin, ref double Xmax, ref double Ymax,
            ref double Zmax)
        {
            throw new NotImplementedException();
        }
