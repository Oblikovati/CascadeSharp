...
namespace CascadeSharp
{
	...
	public  sealed class StdSelect_BRepSelectionTool
	{
		...
		public void ComputeSensitive(TopoDS_Shape theShape, SelectMgr_EntityOwner theOwner, SelectMgr_Selection theSelection, double theDeflection, double theDeflAngle, int theNbPOnEdge, double theMaxiParam, bool theAutoTriang)
		{
			throw new NotImplementedException();
		}

		public void ComputeSensitive(TopoDS_Shape theShape, SelectMgr_EntityOwner theOwner, SelectMgr_Selection theSelection, double theDeflection, double theDeflAngle, int theNbPOnEdge, double theMaxiParam)
		{
			throw new NotImplementedException();
		}
