...
namespace CascadeSharp.TKTopAlgo.MAT
{
	...
	public  sealed class MAT_Graph : Standard_Transient
	{
		...
		public void FusionOfBasicElts(int IndexElt1, int IndexElt2, ref bool MergeArc1, ref int GeomIndexArc1, ref int GeomIndexArc2, ref bool MergeArc2, ref int GeomIndexArc3, ref int GeomIndexArc4)
		{
			throw new NotImplementedException();
		}
