...
namespace CascadeSharp.TKTopAlgo.BRepBuilderAPI
{
    ...
    //---------------------------------------------------------------------
    public sealed class BRepBuilderAPI_MakeFace : BRepBuilderAPI_MakeShape
    {
        ...
        public BRepBuilderAPI_MakeFace(Geom_Surface S, double UMin, double UMax, double VMin, double VMax,
            double TolDegen)
            : base()
        {
            throw new NotImplementedException();
        ...
        public BRepBuilderAPI_MakeFace(TopoDS_Wire W, bool OnlyPlane)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(gp_Pln P, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(gp_Cylinder C, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(gp_Cone C, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(gp_Sphere S, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(gp_Torus C, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(Geom_Surface S, TopoDS_Wire W, bool Inside)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepBuilderAPI_MakeFace(BRepBuilderAPI_MakeFace parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
