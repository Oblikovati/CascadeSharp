...
namespace CascadeSharp.TKTopAlgo.BRepTopAdaptor
{
    ...
    //---------------------------------------------------------------------
    public sealed class BRepTopAdaptor_FClass2d
    {
        public BRepTopAdaptor_FClass2d(TopoDS_Face F, double Tol)
            : base()
        {
            throw new NotImplementedException();
        }

        public BRepTopAdaptor_FClass2d(BRepTopAdaptor_FClass2d parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepTopAdaptor_FClass2d Copy(BRepTopAdaptor_FClass2d Other)
        {
            throw new NotImplementedException();
        }
