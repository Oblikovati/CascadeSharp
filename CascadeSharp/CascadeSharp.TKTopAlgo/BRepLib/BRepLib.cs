...
namespace CascadeSharp.TKTopAlgo.BRepLib
{
    ...
    public sealed class BRepLib
    {
        ...
        public TopoDS_Edge SameParameter(TopoDS_Edge theEdge, double theTolerance, ref double theNewTol,
            bool IsUseOldEdge)
        {
            throw new NotImplementedException();
        }
        ...
        public bool FindValidRange(Adaptor3d_Curve theCurve, double theTolE, double theParV1, gp_Pnt thePntV1,
            double theTolV1, double theParV2, gp_Pnt thePntV2, double theTolV2, ref double theFirst, ref double theLast)
        {
            throw new NotImplementedException();
        }
        ...
        public void ExtendFace(TopoDS_Face theF, double theExtVal, bool theExtUMin, bool theExtUMax, bool theExtVMin,
            bool theExtVMax, TopoDS_Face theFExtended)
        {
            throw new NotImplementedException();
        }
    }; // class BRepLib
