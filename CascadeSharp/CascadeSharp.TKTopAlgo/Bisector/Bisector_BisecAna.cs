...
namespace CascadeSharp.TKTopAlgo.Bisector
{
	...
	public  sealed class Bisector_BisecAna : Bisector_Curve
	{
		...
		public void Perform(Geom2d_Curve Cu, Geom2d_Point Pnt, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance, bool oncurve)
		{
			throw new NotImplementedException();
		}

		public void Perform(Geom2d_Curve Cu, Geom2d_Point Pnt, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance)
		{
			throw new NotImplementedException();
		}

		public void Perform(Geom2d_Point Pnt, Geom2d_Curve Cu, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance, bool oncurve)
		{
			throw new NotImplementedException();
		}

		public void Perform(Geom2d_Point Pnt, Geom2d_Curve Cu, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance)
		{
			throw new NotImplementedException();
		}

		public void Perform(Geom2d_Point Pnt1, Geom2d_Point Pnt2, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance, bool oncurve)
		{
			throw new NotImplementedException();
		}

		public void Perform(Geom2d_Point Pnt1, Geom2d_Point Pnt2, gp_Pnt2d P, gp_Vec2d V1, gp_Vec2d V2, double Sense, double Tolerance)
		{
			throw new NotImplementedException();
		}
		...
		public double Distance(gp_Pnt2d P, GccInt_Bisec B_is, gp_Vec2d V1, gp_Vec2d V2, gp_Vec2d VecRef, double Sense, ref double U, ref bool sense, ref bool ok, bool IsB_isecOfTwoLines)
		{
			throw new NotImplementedException();
		}

		public double Distance(gp_Pnt2d P, GccInt_Bisec B_is, gp_Vec2d V1, gp_Vec2d V2, gp_Vec2d VecRef, double Sense, ref double U, ref bool sense, ref bool ok)
		{
			throw new NotImplementedException();
		}
