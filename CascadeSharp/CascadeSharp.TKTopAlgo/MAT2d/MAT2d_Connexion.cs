...
namespace CascadeSharp.TKTopAlgo.MAT2d
{
	...
	public  sealed class MAT2d_Connexion : Standard_Transient
	{
		...
		public MAT2d_Connexion(int LineA, int LineB, int ItemA, int ItemB, double D_istance, double ParameterOnA, double ParameterOnB, gp_Pnt2d PointA, gp_Pnt2d PointB)
			: base()
		{
			throw new NotImplementedException();
		}
