...
namespace CascadeSharp.TKTopAlgo.MAT2d
{
	...
	public  sealed class MAT2d_Mat2d
	{
		...
		public void LoadBisectorsToRemove(ref int noofb_isectorstoremove, double d_istance1, double d_istance2, MAT_Bisector b_isector1, MAT_Bisector b_isector2, MAT_Bisector b_isector3, MAT_Bisector b_isector4)
		{
			throw new NotImplementedException();
		}

		public void Intersect(MAT2d_Tool2d atool, int aside, ref int noofb_isectorstoremove, MAT_Bisector b_isector1, MAT_Bisector b_isector2)
		{
			throw new NotImplementedException();
		}
