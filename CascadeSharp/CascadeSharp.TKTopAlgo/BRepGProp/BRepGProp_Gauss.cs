...
namespace CascadeSharp.TKTopAlgo.BRepGProp
{
    ...
    public sealed class BRepGProp_Gauss
    {
        ...
        public void Compute(BRepGProp_Face theSurface, gp_Pnt theLocation, double theCoeff, bool theIsByPoint,
        ...
        public void Compute(BRepGProp_Face theSurface, BRepGProp_Domain theDomain, gp_Pnt theLocation, double theCoeff,
            bool theIsByPoint, ref double theOutMass, gp_Pnt theOutGravityCenter, gp_Mat theOutInertia)
        {
            throw new NotImplementedException();
        }

        public void Compute(BRepGProp_Face theSurface, BRepGProp_Domain theDomain, gp_Pnt theLocation,
            ref double theOutMass, gp_Pnt theOutGravityCenter, gp_Mat theOutInertia)
        {
            throw new NotImplementedException();
        }
        ...
        public double Compute(BRepGProp_Face theSurface, BRepGProp_Domain theDomain, gp_Pnt theLocation, double theEps,
            double theCoeff, bool theByPoint, ref double theOutMass, gp_Pnt theOutGravityCenter, gp_Mat theOutInertia)
        {
            throw new NotImplementedException();
        }
