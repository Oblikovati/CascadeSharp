...
namespace CascadeSharp.TKGeomBase.AppParCurves
{
    ...
    //---------------------------------------------------------------------
    public sealed class AppParCurves_ConstraintCouple
    {
        public AppParCurves_ConstraintCouple()
            : base()
        {
        ...
        public AppParCurves_ConstraintCouple(AppParCurves_ConstraintCouple parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
