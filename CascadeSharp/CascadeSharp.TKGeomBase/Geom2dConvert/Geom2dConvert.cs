...
namespace CascadeSharp.TKGeomBase.Geom2dConvert
{
    ...
    public sealed class Geom2dConvert
    {
        ...
        public void ConcatG1(TColGeom2d_Array1OfBSplineCurve ArrayOfCurves, TColStd_Array1OfReal ArrayOfToler,
            TColGeom2d_HArray1OfBSplineCurve ArrayOfConcatenated, ref bool ClosedFlag, double ClosedTolerance)
        {
            throw new NotImplementedException();
        }
