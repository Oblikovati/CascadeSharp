...
namespace CascadeSharp.TKGeomBase.AdvApp2Var
{
    ...
    //---------------------------------------------------------------------
    public sealed class AdvApp2Var_SequenceOfStrip
    {
        public AdvApp2Var_SequenceOfStrip()
            : base()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_SequenceOfStrip(NCollection_BaseAllocator theAllocator)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void Append(AdvApp2Var_SequenceOfStrip theSeq)
        {
            throw new NotImplementedException();
        }
        ...
        public void InsertBefore(int theIndex, AdvApp2Var_SequenceOfStrip theSeq)
        {
            throw new NotImplementedException();
        }

        public void InsertAfter(int theIndex, AdvApp2Var_SequenceOfStrip theSeq)
        {
            throw new NotImplementedException();
        }
