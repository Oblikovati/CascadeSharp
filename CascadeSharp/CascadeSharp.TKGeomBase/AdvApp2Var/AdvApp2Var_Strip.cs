...
namespace CascadeSharp.TKGeomBase.AdvApp2Var
{
    ...
    //---------------------------------------------------------------------
    public sealed class AdvApp2Var_Strip
    {
        public AdvApp2Var_Strip()
            : base()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Strip(NCollection_BaseAllocator theAllocator)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void Prepend(AdvApp2Var_Iso theItem)
        {
            throw new NotImplementedException();
        }

        public void Prepend(AdvApp2Var_Strip theSeq)
        {
            throw new NotImplementedException();
        }

        public void InsertBefore(int theIndex, AdvApp2Var_Iso theItem)
        {
            throw new NotImplementedException();
        }

        public void InsertBefore(int theIndex, AdvApp2Var_Strip theSeq)
        {
            throw new NotImplementedException();
        }
        ...
        public AdvApp2Var_Iso First()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Iso ChangeFirst()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Iso Last()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Iso ChangeLast()
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Iso Value(int theIndex)
        {
            throw new NotImplementedException();
        }

        public AdvApp2Var_Iso ChangeValue(int theIndex)
        {
            throw new NotImplementedException();
        }
