...
namespace CascadeSharp.TKGeomBase.IntAna
{
    ...
    public sealed class IntAna_Quadric
    {
        ...
        public void Coefficients(ref double xCXX, ref double xCYY, ref double xCZZ, ref double xCXY, ref double xCXZ,
            ref double xCYZ, ref double xCX, ref double xCY, ref double xCZ, ref double xCCte)
        {
            throw new NotImplementedException();
        }
