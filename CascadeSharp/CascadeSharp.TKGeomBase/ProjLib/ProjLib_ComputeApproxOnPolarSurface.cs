...
namespace CascadeSharp.TKGeomBase.ProjLib
{
    ...
    public sealed class ProjLib_ComputeApproxOnPolarSurface
    {
        ...
        public ProjLib_ComputeApproxOnPolarSurface(Adaptor2d_HCurve2d InitCurve2d, Adaptor3d_HCurve C,
            Adaptor3d_HSurface S, double Tol)
            : base()
        {
            throw new NotImplementedException();
        }

        public ProjLib_ComputeApproxOnPolarSurface(Adaptor2d_HCurve2d InitCurve2d, Adaptor2d_HCurve2d InitCurve2dB_is,
            Adaptor3d_HCurve C, Adaptor3d_HSurface S, double Tol)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public Geom2d_BSplineCurve ProjectUsingInitialCurve2d(Adaptor3d_HCurve Curve, Adaptor3d_HSurface S,
            Adaptor2d_HCurve2d InitCurve2d)
        {
            throw new NotImplementedException();
        }
