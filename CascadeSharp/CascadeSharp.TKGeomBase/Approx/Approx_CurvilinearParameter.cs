...
namespace CascadeSharp.TKGeomBase.Approx
{
    ...
    {
        public Approx_CurvilinearParameter(Adaptor3d_HCurve C3D, double Tol, GeomAbs_Shape Order, int MaxDegree,
            int MaxSegments)
            : base()
        {
        ...
        public Approx_CurvilinearParameter(Adaptor2d_HCurve2d C2D, Adaptor3d_HSurface Surf, double Tol,
            GeomAbs_Shape Order, int MaxDegree, int MaxSegments)
            : base()
        {
            throw new NotImplementedException();
        }
