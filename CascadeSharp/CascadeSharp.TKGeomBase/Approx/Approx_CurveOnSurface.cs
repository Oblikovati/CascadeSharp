...
namespace CascadeSharp.TKGeomBase.Approx
{
    ...
    public sealed class Approx_CurveOnSurface
    {
        public Approx_CurveOnSurface(Adaptor2d_HCurve2d C2D, Adaptor3d_HSurface Surf, double First, double Last,
            double Tol, GeomAbs_Shape Continuity, int MaxDegree, int MaxSegments, bool Only3d, bool Only2d)
            : base()
        {
        ...
        public Approx_CurveOnSurface(Adaptor2d_HCurve2d C2D, Adaptor3d_HSurface Surf, double First, double Last,
            double Tol, GeomAbs_Shape Continuity, int MaxDegree, int MaxSegments)
            : base()
        {
            throw new NotImplementedException();
        }
