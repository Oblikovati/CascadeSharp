...
namespace CascadeSharp.TKGeomBase.AppDef
{
    ...
    {
        public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint,
        ...
        public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots,
            TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons,
            AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
            : base()
        {
            throw new NotImplementedException();
        }
