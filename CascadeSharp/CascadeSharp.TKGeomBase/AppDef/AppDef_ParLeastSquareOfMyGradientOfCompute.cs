...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class AppDef_ParLeastSquareOfMyGradientOfCompute
	{

		public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfMyGradientOfCompute(AppDef_ParLeastSquareOfMyGradientOfCompute parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfMyGradientOfCompute()
		{
			throw new NotImplementedException();
		}
