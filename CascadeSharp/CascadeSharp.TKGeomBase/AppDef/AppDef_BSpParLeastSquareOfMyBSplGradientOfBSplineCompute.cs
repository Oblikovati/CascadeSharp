...
namespace CascadeSharp.TKGeomBase.AppDef
{
	...
	public  sealed class AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute
	{
		...
		public AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, AppParCurves_Constraint FirstCons, AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}
