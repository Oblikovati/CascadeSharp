...
namespace CascadeSharp.TKGeomBase.AppDef
{
    ...
    //---------------------------------------------------------------------
    public sealed class AppDef_ParFunctionOfMyGradientbisOfBSplineCompute : math_MultipleVarFunctionWithGradient
    {
        public AppDef_ParFunctionOfMyGradientbisOfBSplineCompute(AppDef_MultiLine SSP, int FirstPoint, int LastPoint,
        ...
        public AppDef_ParFunctionOfMyGradientbisOfBSplineCompute(
            AppDef_ParFunctionOfMyGradientbisOfBSplineCompute parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
