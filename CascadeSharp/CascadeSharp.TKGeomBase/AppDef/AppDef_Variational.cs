...
namespace CascadeSharp
{
	...
	public  sealed class AppDef_Variational
	{
		...
		public AppDef_Variational(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_HArray1OfConstraintCouple TheConstraints, int MaxDegree, int MaxSegment)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_Variational(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_HArray1OfConstraintCouple TheConstraints, int MaxDegree)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_Variational(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_HArray1OfConstraintCouple TheConstraints)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void TheMotor(AppDef_SmoothCriterion J, double WQuadratic, double WQuality, FEmTool_Curve TheCurve, TColStd_Array1OfReal Ecarts)
		{
			throw new NotImplementedException();
		}

		public void Adjusting(AppDef_SmoothCriterion J, ref double WQuadratic, ref double WQuality, FEmTool_Curve TheCurve, TColStd_Array1OfReal Ecarts)
		{
			throw new NotImplementedException();
		}

		public void Optimization(AppDef_SmoothCriterion J, FEmTool_Assembly A, bool ToAssemble, double EpsDeg, FEmTool_Curve Curve, TColStd_Array1OfReal Parameters)
		{
			throw new NotImplementedException();
		}

		public void Project(FEmTool_Curve C, TColStd_Array1OfReal Ti, TColStd_Array1OfReal ProjTi, TColStd_Array1OfReal D_istance, ref int NumPoints, ref double MaxErr, ref double QuaErr, ref double AveErr, int NbIterations)
		{
			throw new NotImplementedException();
		}

		public void Project(FEmTool_Curve C, TColStd_Array1OfReal Ti, TColStd_Array1OfReal ProjTi, TColStd_Array1OfReal D_istance, ref int NumPoints, ref double MaxErr, ref double QuaErr, ref double AveErr)
		{
			throw new NotImplementedException();
		}
		...
		public void SplitCurve(FEmTool_Curve InCurve, TColStd_Array1OfReal Ti, double CurveTol, FEmTool_Curve OutCurve, ref bool _iscut)
		{
			throw new NotImplementedException();
		}
		...
		public void AssemblingConstraints(FEmTool_Curve Curve, TColStd_Array1OfReal Parameters, double CBLONG, FEmTool_Assembly A)
		{
			throw new NotImplementedException();
		}
