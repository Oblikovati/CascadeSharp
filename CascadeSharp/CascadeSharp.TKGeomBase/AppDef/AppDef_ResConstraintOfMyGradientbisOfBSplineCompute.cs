...
namespace CascadeSharp.TKGeomBase.AppDef
{
    ...
    {
        public AppDef_ResConstraintOfMyGradientbisOfBSplineCompute(AppDef_MultiLine SSP, AppParCurves_MultiCurve SCurv,
        ...
        public AppDef_ResConstraintOfMyGradientbisOfBSplineCompute(
            AppDef_ResConstraintOfMyGradientbisOfBSplineCompute parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
