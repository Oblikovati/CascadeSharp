...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class AppDef_TheFunction : CascadeSharp.math_MultipleVarFunctionWithGradient
	{

		public AppDef_TheFunction(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_HArray1OfConstraintCouple TheConstraints, math_Vector Parameters, int Deg)
			: base()
		{
