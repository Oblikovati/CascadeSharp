...
namespace CascadeSharp
{
	...
	public  sealed class AppDef_ParLeastSquareOfTheGradient
	{
		...
		public AppDef_ParLeastSquareOfTheGradient(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfTheGradient(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfTheGradient(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, math_Vector Parameters, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParLeastSquareOfTheGradient(AppDef_MultiLine SSP, TColStd_Array1OfReal Knots, TColStd_Array1OfInteger Mults, int FirstPoint, int LastPoint, CascadeSharp.AppParCurves_Constraint FirstCons, CascadeSharp.AppParCurves_Constraint LastCons, int NbPol)
			: base()
		{
			throw new NotImplementedException();
		}
