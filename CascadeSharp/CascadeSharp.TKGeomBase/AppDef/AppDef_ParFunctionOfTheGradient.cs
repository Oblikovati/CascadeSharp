...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class AppDef_ParFunctionOfTheGradient : CascadeSharp.math_MultipleVarFunctionWithGradient
	{

		public AppDef_ParFunctionOfTheGradient(AppDef_MultiLine SSP, int FirstPoint, int LastPoint, AppParCurves_HArray1OfConstraintCouple TheConstraints, math_Vector Parameters, int Deg)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParFunctionOfTheGradient(AppDef_ParFunctionOfTheGradient parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public AppDef_ParFunctionOfTheGradient()
		{
			throw new NotImplementedException();
		}
