...
namespace CascadeSharp.TKG2d.TColGeom2d
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColGeom2d_SequenceOfGeometry
    {
        public TColGeom2d_SequenceOfGeometry()
            : base()
        {
            throw new NotImplementedException();
        }

        public TColGeom2d_SequenceOfGeometry(NCollection_BaseAllocator theAllocator)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public void Prepend(Geom2d_Geometry theItem)
        {
            throw new NotImplementedException();
        }

        public void Prepend(TColGeom2d_SequenceOfGeometry theSeq)
        {
            throw new NotImplementedException();
        }
        ...
        public void InsertBefore(int theIndex, TColGeom2d_SequenceOfGeometry theSeq)
        {
            throw new NotImplementedException();
        }

        public void InsertAfter(int theIndex, TColGeom2d_SequenceOfGeometry theSeq)
        {
            throw new NotImplementedException();
        }
        ...
        public Geom2d_Geometry First()
        {
            throw new NotImplementedException();
        }

        public Geom2d_Geometry ChangeFirst()
        {
            throw new NotImplementedException();
        }

        public Geom2d_Geometry Last()
        {
            throw new NotImplementedException();
        }

        public Geom2d_Geometry ChangeLast()
        {
            throw new NotImplementedException();
        }

        public Geom2d_Geometry Value(int theIndex)
        {
            throw new NotImplementedException();
        }

        public Geom2d_Geometry ChangeValue(int theIndex)
        {
            throw new NotImplementedException();
        }
