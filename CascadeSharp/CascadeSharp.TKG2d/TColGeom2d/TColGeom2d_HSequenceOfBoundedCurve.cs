...
namespace CascadeSharp.TKG2d.TColGeom2d
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColGeom2d_HSequenceOfBoundedCurve : Standard_Transient
	{

		public TColGeom2d_HSequenceOfBoundedCurve()
			: base()
		{
		...
		public TColGeom2d_HSequenceOfBoundedCurve(TColGeom2d_HSequenceOfBoundedCurve parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public TColGeom2d_SequenceOfBoundedCurve Sequence()
		{
			throw new NotImplementedException();
		}
		...
		public TColGeom2d_SequenceOfBoundedCurve ChangeSequence()
		{
			throw new NotImplementedException();
		}
