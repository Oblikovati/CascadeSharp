...
namespace CascadeSharp.TKG2d.TColGeom2d
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColGeom2d_HArray1OfCurve : Standard_Transient
	{

		public TColGeom2d_HArray1OfCurve()
			: base()
		{
		...
		public TColGeom2d_HArray1OfCurve(TColGeom2d_HArray1OfCurve parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
