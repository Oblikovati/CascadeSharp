...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepOffsetAPI_MakePipeShell : CascadeSharp.BRepPrimAPI_MakeSweep
	{
		...
		public void SetMode(TopoDS_Wire AuxiliarySpine, bool CurvilinearEquivalence, CascadeSharp.BRepFill_TypeOfContact KeepContact)
		{
			throw new NotImplementedException();
		}
		...
		public void SetLaw(TopoDS_Shape Profile, Law_Function L, TopoDS_Vertex Location, bool WithContact, bool WithCorrection)
		{
			throw new NotImplementedException();
		}
		...
		public CascadeSharp.BRepBuilderAPI_PipeError GetStatus()
		{
			throw new NotImplementedException();
		}
		...
		public void SetTransitionMode(CascadeSharp.BRepBuilderAPI_TransitionMode Mode)
		{
			throw new NotImplementedException();
		}
