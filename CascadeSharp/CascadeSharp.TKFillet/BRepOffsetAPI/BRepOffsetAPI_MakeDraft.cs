...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepOffsetAPI_MakeDraft : CascadeSharp.BRepBuilderAPI_MakeShape
	{
		...
		public void SetOptions(CascadeSharp.BRepBuilderAPI_TransitionMode Style, double AngleMin, double AngleMax)
		{
			throw new NotImplementedException();
		}

		public void SetOptions(CascadeSharp.BRepBuilderAPI_TransitionMode Style, double AngleMin)
		{
			throw new NotImplementedException();
		}

		public void SetOptions(CascadeSharp.BRepBuilderAPI_TransitionMode Style)
		{
			throw new NotImplementedException();
		}
