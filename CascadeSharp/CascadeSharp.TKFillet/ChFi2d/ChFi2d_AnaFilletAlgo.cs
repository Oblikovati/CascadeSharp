...
namespace CascadeSharp.TKFillet.ChFi2d
{
    ...
    public sealed class ChFi2d_AnaFilletAlgo
    {
        ...
        public bool SegmentFilletSegment(double radius, ref double xc, ref double yc, ref bool cw, ref double start,
            ref double end)
        {
            throw new NotImplementedException();
        }

        public bool SegmentFilletArc(double radius, ref double xc, ref double yc, ref bool cw, ref double start,
            ref double end, ref double xend, ref double yend)
        {
            throw new NotImplementedException();
        }

        public bool ArcFilletSegment(double radius, ref double xc, ref double yc, ref bool cw, ref double start,
            ref double end, ref double xstart, ref double ystart)
        {
            throw new NotImplementedException();
        }

        public bool ArcFilletArc(double radius, ref double xc, ref double yc, ref bool cw, ref double start,
            ref double end)
        {
            throw new NotImplementedException();
        }
