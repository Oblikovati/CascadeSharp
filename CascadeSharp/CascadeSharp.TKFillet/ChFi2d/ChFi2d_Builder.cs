...
namespace CascadeSharp.TKFillet.ChFi2d
{
    ...
    public sealed class ChFi2d_Builder
    {
        ...
        public void ComputeFillet(TopoDS_Vertex V, TopoDS_Edge E1, TopoDS_Edge E2, double Radius, TopoDS_Edge TrimE1,
            TopoDS_Edge TrimE2, TopoDS_Edge Fillet)
        {
            throw new NotImplementedException();
        }

        public void ComputeChamfer(TopoDS_Vertex V, TopoDS_Edge E1, TopoDS_Edge E2, double D1, double D2,
            TopoDS_Edge TrimE1, TopoDS_Edge TrimE2, TopoDS_Edge Chamfer)
        {
            throw new NotImplementedException();
        }

        public void ComputeChamfer(TopoDS_Vertex V, TopoDS_Edge E1, double D, double Ang, TopoDS_Edge E2,
            TopoDS_Edge TrimE1, TopoDS_Edge TrimE2, TopoDS_Edge Chamfer)
        {
            throw new NotImplementedException();
        }

        public TopoDS_Edge BuildFilletEdge(TopoDS_Vertex V, TopoDS_Edge AdjEdge1, TopoDS_Edge AdjEdge2, double Radius,
            TopoDS_Vertex NewExtr1, TopoDS_Vertex NewExtr2)
        {
            throw new NotImplementedException();
        }

        public TopoDS_Edge BuildChamferEdge(TopoDS_Vertex V, TopoDS_Edge AdjEdge1, TopoDS_Edge AdjEdge2, double D1,
            double D2, TopoDS_Vertex NewExtr1, TopoDS_Vertex NewExtr2)
        {
            throw new NotImplementedException();
        }

        public TopoDS_Edge BuildChamferEdge(TopoDS_Vertex V, TopoDS_Edge AdjEdge2, double D, double Ang,
            TopoDS_Edge AdjEdge1, TopoDS_Vertex NewExtr1, TopoDS_Vertex NewExtr2)
        {
            throw new NotImplementedException();
        }

        public void BuildNewWire(TopoDS_Edge OldE1, TopoDS_Edge OldE2, TopoDS_Edge E1, TopoDS_Edge Fillet,
            TopoDS_Edge E2)
        {
            throw new NotImplementedException();
        }
