...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class Draft_Modification : CascadeSharp.BRepTools_Modification
	{
		...
		public CascadeSharp.Draft_ErrorStatus Error()
		{
			throw new NotImplementedException();
		}
		...
		public Geom_Curve NewCurve(Geom_Curve C, Geom_Surface S, CascadeSharp.TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane, bool Flag)
		{
			throw new NotImplementedException();
		}

		public Geom_Curve NewCurve(Geom_Curve C, Geom_Surface S, CascadeSharp.TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane)
		{
			throw new NotImplementedException();
		}

		public Geom_Surface NewSurface(Geom_Surface S, CascadeSharp.TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane)
		{
			throw new NotImplementedException();
		}
