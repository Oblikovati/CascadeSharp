...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BlendFunc_Ruled : CascadeSharp.Blend_Function
	{
		...
		public bool GetSection(double Param, double U1, double V1, double U2, double V2, TColgp_Array1OfPnt tabP, TColgp_Array1OfVec tabV)
		{
			throw new NotImplementedException();
		}
