...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BlendFunc_CSCircular : CascadeSharp.Blend_CSFunction
	{
		...
		public BlendFunc_CSCircular(BlendFunc_CSCircular parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public BlendFunc_CSCircular()
		{
			throw new NotImplementedException();
		}
