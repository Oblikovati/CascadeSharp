...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BlendFunc_ChAsym : CascadeSharp.Blend_Function
	{

		public BlendFunc_ChAsym(Adaptor3d_HSurface S1, Adaptor3d_HSurface S2, Adaptor3d_HCurve C)
			: base()
		{
			throw new NotImplementedException();
		}

		public BlendFunc_ChAsym(BlendFunc_ChAsym parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public BlendFunc_ChAsym()
		{
			throw new NotImplementedException();
		}
