...
namespace CascadeSharp.TKMath.BSplSLib
{
    ...
    public sealed class BSplSLib
    {
        ...
        public void D0(double U, double V, int UIndex, int VIndex, TColgp_Array2OfPnt Poles,
            ...
            bool VRat, bool UPer, bool VPer, gp_Pnt P)
        {
            throw new NotImplementedException();
        }

        public void D1(double U, double V, int UIndex, int VIndex, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots,
            TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int Degree, int VDegree, bool URat,
            bool VRat, bool UPer, bool VPer, gp_Pnt P, gp_Vec Vu, gp_Vec Vv)
        {
            throw new NotImplementedException();
        }

        public void D2(double U, double V, int UIndex, int VIndex, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots,
            TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool URat,
            bool VRat, bool UPer, bool VPer, gp_Pnt P, gp_Vec Vu, gp_Vec Vv, gp_Vec Vuu, gp_Vec Vvv, gp_Vec Vuv)
        {
            throw new NotImplementedException();
        }

        public void D3(double U, double V, int UIndex, int VIndex, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots,
            TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool URat,
            bool VRat, bool UPer, bool VPer, gp_Pnt P, gp_Vec Vu, gp_Vec Vv, gp_Vec Vuu, gp_Vec Vvv, gp_Vec Vuv,
            gp_Vec Vuuu, gp_Vec Vvvv, gp_Vec Vuuv, gp_Vec Vuvv)
        {
            throw new NotImplementedException();
        }
        ...
        public void HomogeneousD1(double U, double V, int UIndex, int VIndex, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, TColStd_Array1OfReal UKnots, TColStd_Array1OfReal VKnots,
            TColStd_Array1OfInteger UMults, TColStd_Array1OfInteger VMults, int UDegree, int VDegree, bool URat,
            bool VRat, bool UPer, bool VPer, gp_Pnt N, gp_Vec Nu, gp_Vec Nv, ref double D, ref double Du, ref double Dv)
        {
            throw new NotImplementedException();
        }
        ...
        public void SetPoles(TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, TColStd_Array1OfReal FP,
            bool UDirection)
        {
            throw new NotImplementedException();
        }
        ...
        public void Unperiodize(bool UDirection, int Degree, TColStd_Array1OfInteger Mults, TColStd_Array1OfReal Knots,
            TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, TColStd_Array1OfInteger NewMults,
            TColStd_Array1OfReal NewKnots, TColgp_Array2OfPnt NewPoles, TColStd_Array2OfReal NewWeights)
        {
            throw new NotImplementedException();
        }
        ...
        public void CacheD0(double U, double V, int UDegree, int VDegree, double UCacheParameter,
            double VCacheParameter, double USpanLenght, double VSpanLength, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, gp_Pnt Point)
        {
            throw new NotImplementedException();
        }
        ...
        public void CacheD1(double U, double V, int UDegree, int VDegree, double UCacheParameter,
            double VCacheParameter, double USpanLenght, double VSpanLength, TColgp_Array2OfPnt Poles,
            TColStd_Array2OfReal Weights, gp_Pnt Point, gp_Vec VecU, gp_Vec VecV)
        {
            throw new NotImplementedException();
        }

        public void CoefsD1(double U, double V, TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, gp_Pnt Point,
            gp_Vec VecU, gp_Vec VecV)
        {
            throw new NotImplementedException();
        }
        ...
        public void Interpolate(int UDegree, int VDegree, TColStd_Array1OfReal UFlatKnots,
            ...
            TColgp_Array2OfPnt Poles, TColStd_Array2OfReal Weights, ref int InversionProblem)
        {
            throw new NotImplementedException();
        }
