...
namespace CascadeSharp.TKMath.Bnd
{
	...
	public  sealed class Bnd_OBB
	{
		...
		public Bnd_OBB(gp_Pnt theCenter, gp_Dir theXDirection, gp_Dir theYDirection, gp_Dir theZDirection, double theHXSize, double theHYSize, double theHZSize)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void ReBuild(TColgp_Array1OfPnt theL_istOfPoints, TColStd_Array1OfReal theL_istOfTolerances, bool theIsOptimal)
		{
			throw new NotImplementedException();
		}
