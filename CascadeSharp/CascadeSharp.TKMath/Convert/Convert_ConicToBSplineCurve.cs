...
namespace CascadeSharp.TKMath.Convert
{
    ...
    public class Convert_ConicToBSplineCurve
    {
        ...
        public void BuildCosAndSin(Convert_ParameterisationType Parametr_isation, TColStd_HArray1OfReal CosNumerator,
            TColStd_HArray1OfReal SinNumerator, TColStd_HArray1OfReal Denominator, ref int Degree,
            TColStd_HArray1OfReal Knots, TColStd_HArray1OfInteger Mults)
        {
            throw new NotImplementedException();
        }
