...
namespace CascadeSharp.TKMath.PLib
{
	...
	public  sealed class PLib_JacobiPolynomial : PLib_Base
	{
		...
		public void ReduceDegree(int Dimension, int MaxDegree, double Tol, ref double JacCoeff, ref int NewDegree, ref double MaxError)
		{
			throw new NotImplementedException();
		}
		...
		public void ToCoefficients(int Dimension, int Degree, TColStd_Array1OfReal JacCoeff, TColStd_Array1OfReal Coefficients)
		{
			throw new NotImplementedException();
		}
