...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class PLib_HermitJacobi : CascadeSharp.PLib_Base
	{

		public PLib_HermitJacobi(int WorkDegree, CascadeSharp.GeomAbs_Shape ConstraintOrder)
			: base()
		{
		...
		public void ReduceDegree(int Dimension, int MaxDegree, double Tol, ref double HermJacCoeff, ref int NewDegree, ref double MaxError)
		{
			throw new NotImplementedException();
		}
		...
		public void ToCoefficients(int Dimension, int Degree, TColStd_Array1OfReal HermJacCoeff, TColStd_Array1OfReal Coefficients)
		{
			throw new NotImplementedException();
		}
		...
		public char get_type_name()
		{
			throw new NotImplementedException("Native class returns pointer to integer/double/handle.");
						...
						public void D0123(int NDerive, double U, TColStd_Array1OfReal Bas_isValue, TColStd_Array1OfReal Bas_isD1, TColStd_Array1OfReal Bas_isD2, TColStd_Array1OfReal Bas_isD3)
		{
			throw new NotImplementedException();
		}
