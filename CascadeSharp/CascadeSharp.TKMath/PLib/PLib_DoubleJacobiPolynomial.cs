...
namespace CascadeSharp.TKMath.PLib
{
	...
	public  sealed class PLib_DoubleJacobiPolynomial
	{
		...
		public double MaxError(int Dimension, int MinDegreeU, int MaxDegreeU, int MinDegreeV, int MaxDegreeV, int dJacCoeff, TColStd_Array1OfReal JacCoeff, double Error)
		{
			throw new NotImplementedException();
		}

		public void ReduceDegree(int Dimension, int MinDegreeU, int MaxDegreeU, int MinDegreeV, int MaxDegreeV, int dJacCoeff, TColStd_Array1OfReal JacCoeff, double EpmsCut, ref double MaxError, ref int NewDegreeU, ref int NewDegreeV)
		{
			throw new NotImplementedException();
		}

		public double AverageError(int Dimension, int DegreeU, int DegreeV, int dJacCoeff, TColStd_Array1OfReal JacCoeff)
		{
			throw new NotImplementedException();
		}

		public void WDoubleJacobiToCoefficients(int Dimension, int DegreeU, int DegreeV, TColStd_Array1OfReal JacCoeff, TColStd_Array1OfReal Coefficients)
		{
			throw new NotImplementedException();
		}
