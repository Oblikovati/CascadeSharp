...
namespace CascadeSharp.TKMath.gp
{
	...
	//  Class  gp_Elips2d
	//---------------------------------------------------------------------
	public  sealed class gp_Elips2d
	{
		...
		public gp_Elips2d(gp_Ax2d MajorAx_is, double MajorRadius, double MinorRadius, bool Sense)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public gp_Elips2d(gp_Elips2d parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
