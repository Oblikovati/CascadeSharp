...
namespace CascadeSharp.TKMath.gp
{
    ...
    public sealed class gp_Trsf
    {
        ...
        public void SetValues(double a11, double a12, double a13, double a14, double a21, double a22, double a23,
            double a24, double a31, double a32, double a33, double a34)
        {
            throw new NotImplementedException();
        }
