...
namespace CascadeSharp.TKMath.gp
{
	...
	public  sealed class gp_Ax1
	{
		...
		public gp_Ax1(gp_Ax1 parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public bool IsCoaxial(gp_Ax1 Other, double AngularTolerance, double LinearTolerance)
		{
			throw new NotImplementedException();
		}

		public bool IsNormal(gp_Ax1 Other, double AngularTolerance)
		{
			throw new NotImplementedException();
		}

		public bool IsOpposite(gp_Ax1 Other, double AngularTolerance)
		{
			throw new NotImplementedException();
		}

		public bool IsParallel(gp_Ax1 Other, double AngularTolerance)
		{
			throw new NotImplementedException();
		}
