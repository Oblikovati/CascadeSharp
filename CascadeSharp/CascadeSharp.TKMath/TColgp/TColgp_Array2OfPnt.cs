...
namespace CascadeSharp.TKMath.TColgp
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColgp_Array2OfPnt
    {
        public TColgp_Array2OfPnt()
            : base()
        {
        ...
        public TColgp_Array2OfPnt Move(TColgp_Array2OfPnt theOther)
        {
            throw new NotImplementedException();
        }
        ...
        public void fillIndexTable(gp_Pnt theTable)
        {
            throw new NotImplementedException();
        }
    }; // class TColgp_Array2OfPnt
