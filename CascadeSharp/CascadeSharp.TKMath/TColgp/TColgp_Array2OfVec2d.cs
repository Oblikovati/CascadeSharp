...
namespace CascadeSharp.TKMath.TColgp
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColgp_Array2OfVec2d
    {
        public TColgp_Array2OfVec2d()
            : base()
        {
        ...
        public TColgp_Array2OfVec2d(gp_Vec2d theBegin, int theRowLower, int theRowUpper, int theColLower,
            int theColUpper)
            : base()
        {
            throw new NotImplementedException();
        ...
        public TColgp_Array2OfVec2d Move(TColgp_Array2OfVec2d theOther)
        {
            throw new NotImplementedException();
        }
        ...
        public void fillIndexTable(gp_Vec2d theTable)
        {
            throw new NotImplementedException();
        }
    }; // class TColgp_Array2OfVec2d
