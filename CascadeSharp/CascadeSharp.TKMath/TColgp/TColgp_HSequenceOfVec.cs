...
namespace CascadeSharp.TKMath.TColgp
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColgp_HSequenceOfVec : Standard_Transient
    {
        public TColgp_HSequenceOfVec()
            : base()
        {
        ...
        public TColgp_HSequenceOfVec(TColgp_HSequenceOfVec parameter1)
            : base()
        {
            throw new NotImplementedException();
        }

        public TColgp_SequenceOfVec Sequence()
        {
            throw new NotImplementedException();
        }
        ...
        public TColgp_SequenceOfVec ChangeSequence()
        {
            throw new NotImplementedException();
        }
