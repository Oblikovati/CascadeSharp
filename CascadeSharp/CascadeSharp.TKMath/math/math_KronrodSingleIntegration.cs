...
namespace CascadeSharp
{
	...
	public  sealed class math_KronrodSingleIntegration
	{
		...
		public math_KronrodSingleIntegration(math_Function theFunction, double theLower, double theUpper, int theNbPnts, double theTolerance, int theMaxNbIter)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Perform(math_Function theFunction, double theLower, double theUpper, int theNbPnts, double theTolerance, int theMaxNbIter)
		{
			throw new NotImplementedException();
		}
		...
		public bool GKRule(math_Function theFunction, double theLower, double theUpper, math_Vector theGaussP, math_Vector theGaussW, math_Vector theKronrodP, math_Vector theKronrodW, ref double theValue, ref double theError)
		{
			throw new NotImplementedException();
		}
