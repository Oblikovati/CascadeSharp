...
namespace CascadeSharp
{
	...
	public  class math_NewtonMinimum
	{
		...
		public math_NewtonMinimum(math_MultipleVarFunctionWithHessian theFunction, double theTolerance, int theNbIterations, double theConvexity, bool theWithSingularity)
			: base()
		{
			throw new NotImplementedException();
		}

		public math_NewtonMinimum(math_MultipleVarFunctionWithHessian theFunction, double theTolerance, int theNbIterations, double theConvexity)
			: base()
		{
			throw new NotImplementedException();
		}

		public math_NewtonMinimum(math_MultipleVarFunctionWithHessian theFunction, double theTolerance, int theNbIterations)
			: base()
		{
			throw new NotImplementedException();
		}
