...
namespace CascadeSharp.TKMath.math
{
    ...
    public sealed class math_NotSquare : Standard_DimensionError
    {
        ...
        public math_NotSquare(string theMessage)
            : base()
        {
            throw new NotImplementedException();
        }

        public math_NotSquare(math_NotSquare parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public math_NotSquare NewInstance(string theMessage)
        {
            throw new NotImplementedException();
        }

        public math_NotSquare NewInstance()
        {
            throw new NotImplementedException();
        }
