...
namespace CascadeSharp.TKMath.math
{
	...
	public  sealed class math_Powell
	{
		...
		public math_Powell(math_MultipleVarFunction theFunction, double theTolerance, int theNbIterations, double theZEPS)
			: base()
		{
		...
		public void Perform(math_MultipleVarFunction theFunction, math_Vector theStartingPoint, math_Matrix theStartingDirections)
		{
			throw new NotImplementedException();
		}
