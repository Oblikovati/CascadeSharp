...
namespace CascadeSharp.TKMath.math
{
	...
	public  sealed class math_GlobOptMin
	{
		...
		public math_GlobOptMin(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC, double theD_iscretizationTol, double theSameTol)
			: base()
		{
			throw new NotImplementedException();
		}

		public math_GlobOptMin(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC, double theD_iscretizationTol)
			: base()
		{
			throw new NotImplementedException();
		}

		public math_GlobOptMin(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void SetGlobalParams(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC, double theD_iscretizationTol, double theSameTol)
		{
			throw new NotImplementedException();
		}

		public void SetGlobalParams(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC, double theD_iscretizationTol)
		{
			throw new NotImplementedException();
		}

		public void SetGlobalParams(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder, double theC)
		{
			throw new NotImplementedException();
		}

		public void SetGlobalParams(math_MultipleVarFunction theFunc, math_Vector theLowerBorder, math_Vector theUpperBorder)
		{
			throw new NotImplementedException();
		}
