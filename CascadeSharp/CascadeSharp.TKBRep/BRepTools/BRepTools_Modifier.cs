...
namespace CascadeSharp.TKBRep.BRepTools
{
    ...
    public sealed class BRepTools_Modifier
    {
        ...
        public void CreateOtherVertices(TopTools_IndexedDataMapOfShapeListOfShape theMVE,
            TopTools_IndexedDataMapOfShapeListOfShape theMEF, BRepTools_Modification M)
        {
            throw new NotImplementedException();
        }
    }; // class BRepTools_Modifier
