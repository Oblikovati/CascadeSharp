...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepTools_NurbsConvertModification : CascadeSharp.BRepTools_Modification
	{

		public BRepTools_NurbsConvertModification()
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepTools_NurbsConvertModification(BRepTools_NurbsConvertModification parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public TopTools_ListOfShape GetUpdatedEdges()
		{
			throw new NotImplementedException();
		}
