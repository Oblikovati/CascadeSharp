...
namespace CascadeSharp.TKBRep.TopTools
{
	...
	//---------------------------------------------------------------------
	public  sealed class TopTools_IndexedDataMapOfShapeListOfShape
	{
		...
		public TopTools_ListOfShape Seek(TopoDS_Shape theKey1)
		{
			throw new NotImplementedException();
		}

		public TopTools_ListOfShape ChangeSeek(TopoDS_Shape theKey1)
		{
			throw new NotImplementedException();
		}

		public bool FindFromKey(TopoDS_Shape theKey1, TopTools_ListOfShape theValue)
		{
			throw new NotImplementedException();
		}
