...
namespace CascadeSharp.TKBRep.BRep
{
    ...
    public sealed class BRep_Builder : TopoDS_Builder
    {
        ...
        public void UpdateEdge(TopoDS_Edge E, Geom2d_Curve C, Geom_Surface S, TopLoc_Location L, double Tol,
            gp_Pnt2d Pf, gp_Pnt2d Pl)
        {
            throw new NotImplementedException();
        }

        public void UpdateEdge(TopoDS_Edge E, Geom2d_Curve C1, Geom2d_Curve C2, Geom_Surface S, TopLoc_Location L,
            double Tol)
        {
            throw new NotImplementedException();
        }
        ...
        public void UpdateEdge(TopoDS_Edge E, Geom2d_Curve C1, Geom2d_Curve C2, Geom_Surface S, TopLoc_Location L,
            double Tol, gp_Pnt2d Pf, gp_Pnt2d Pl)
        {
            throw new NotImplementedException();
        }
        ...
        public void Continuity(TopoDS_Edge E, Geom_Surface S1, Geom_Surface S2, TopLoc_Location L1, TopLoc_Location L2,
            GeomAbs_Shape C)
        {
            throw new NotImplementedException();
        }
        ...
        public void UpdateVertex(TopoDS_Vertex V, double P, TopoDS_Edge E, Geom_Surface S, TopLoc_Location L,
            double Tol)
        {
            throw new NotImplementedException();
        }
