...
namespace CascadeSharp.TKBRep.BRep
{
    ...
    public sealed class BRep_Tool
    {
        ...
        public Geom2d_Curve CurveOnSurface(TopoDS_Edge E, Geom_Surface S, TopLoc_Location L, ref double First,
            ref double Last, ref bool theIsStored)
        {
            throw new NotImplementedException();
        }
        ...
        public Geom2d_Curve CurveOnPlane(TopoDS_Edge E, Geom_Surface S, TopLoc_Location L, ref double First,
            ref double Last)
        {
            throw new NotImplementedException();
        }

        public void CurveOnSurface(TopoDS_Edge E, Geom2d_Curve C, Geom_Surface S, TopLoc_Location L, ref double First,
            ref double Last)
        {
            throw new NotImplementedException();
        }
        ...
        public bool HasContinuity(TopoDS_Edge E, Geom_Surface S1, Geom_Surface S2, TopLoc_Location L1,
            TopLoc_Location L2)
        {
            throw new NotImplementedException();
        }
