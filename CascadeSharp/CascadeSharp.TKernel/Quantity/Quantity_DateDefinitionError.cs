...
namespace CascadeSharp.TKernel.Quantity
{
    ...
    public sealed class Quantity_DateDefinitionError : Standard_DomainError
    {
        ...
        public Quantity_DateDefinitionError(string theMessage)
            : base()
        {
            throw new NotImplementedException();
        }

        public Quantity_DateDefinitionError(Quantity_DateDefinitionError parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public Quantity_DateDefinitionError NewInstance(string theMessage)
        {
            throw new NotImplementedException();
        }

        public Quantity_DateDefinitionError NewInstance()
        {
            throw new NotImplementedException();
        }
