...
namespace CascadeSharp.TKernel.Message
{
    ...
    //  Class  Message_Msg
    //---------------------------------------------------------------------
    public sealed class Message_Msg
    {
        public Message_Msg()
            : base()
        {
        ...
        public int getFormat(int theType, TCollection_AsciiString theFormat)
        {
            throw new NotImplementedException();
        }

        public void replaceText(int theFirst, int theNb, TCollection_ExtendedString theStr)
        {
            throw new NotImplementedException();
        }
    }; // class Message_Msg
