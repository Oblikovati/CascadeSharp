...
namespace CascadeSharp.TKernel.TColStd
{
    ...
    //---------------------------------------------------------------------
    public sealed class TColStd_HSequenceOfHExtendedString : Standard_Transient
    {
        ...
        public TColStd_HSequenceOfHExtendedString(TColStd_HSequenceOfHExtendedString parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
