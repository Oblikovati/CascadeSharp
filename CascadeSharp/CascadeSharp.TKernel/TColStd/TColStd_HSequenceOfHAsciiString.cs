...
namespace CascadeSharp.TKernel.TColStd
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColStd_HSequenceOfHAsciiString : Standard_Transient
	{
		...
		public TColStd_HSequenceOfHAsciiString(TColStd_HSequenceOfHAsciiString parameter1)
			: base()
		{
			throw new NotImplementedException();
		}
