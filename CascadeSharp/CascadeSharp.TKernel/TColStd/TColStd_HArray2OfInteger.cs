...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColStd_HArray2OfInteger : Standard_Transient
	{
		...
		public TColStd_HArray2OfInteger(TColStd_HArray2OfInteger parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public TColStd_HArray2OfInteger()
		{
			throw new NotImplementedException();
		}
		...
		public bool IsDeletable()
		{
			throw new NotImplementedException();
						...
						public int Value(int theRow, int theCol)
		{
			throw new NotImplementedException();
		}

		public int ChangeValue(int theRow, int theCol)
		{
			throw new NotImplementedException();
		}
		...
		public void fillIndexTable(ref int theTable)
		{
			throw new NotImplementedException();
		}
