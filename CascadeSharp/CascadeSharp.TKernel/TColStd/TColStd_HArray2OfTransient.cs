...
namespace CascadeSharp.TKernel.TColStd
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColStd_HArray2OfTransient : Standard_Transient
	{
		...
		public TColStd_HArray2OfTransient(TColStd_HArray2OfTransient parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public TColStd_HArray2OfTransient()
		{
			throw new NotImplementedException();
		}
