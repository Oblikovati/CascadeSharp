...
namespace CascadeSharp.TKernel.TColStd
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColStd_MapOfTransient
	{
		...
		public bool Contains(Standard_Transient K)
		{
			throw new NotImplementedException();
		}

		public bool Remove(Standard_Transient K)
		{
			throw new NotImplementedException();
		}
		...
		public bool IsEqual(TColStd_MapOfTransient theOther)
		{
			throw new NotImplementedException();
		}

		public bool Contains(TColStd_MapOfTransient theOther)
		{
			throw new NotImplementedException();
		}
		...
		public bool Intersect(TColStd_MapOfTransient theOther)
		{
			throw new NotImplementedException();
		}
		...
		public bool Subtract(TColStd_MapOfTransient theOther)
		{
			throw new NotImplementedException();
		}
		...
		public bool Differ(TColStd_MapOfTransient theOther)
		{
			throw new NotImplementedException();
		}
