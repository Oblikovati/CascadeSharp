...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class TColStd_HArray2OfReal : Standard_Transient
	{
		...
		public TColStd_HArray2OfReal(TColStd_HArray2OfReal parameter1)
			: base()
		{
			throw new NotImplementedException();
		}

		public TColStd_HArray2OfReal()
		{
			throw new NotImplementedException();
		}
		...
		public double ChangeValue(int theRow, int theCol)
		{
			throw new NotImplementedException();
		}
		...
		public void fillIndexTable(ref double theTable)
		{
			throw new NotImplementedException();
		}
