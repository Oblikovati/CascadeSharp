...
namespace CascadeSharp.TKernel.TCollection
{
	...
	//---------------------------------------------------------------------
	public  sealed class TCollection_HAsciiString : Standard_Transient
	{
		...
		public bool IsLess(TCollection_HAsciiString other)
		{
			throw new NotImplementedException();
		}

		public bool IsGreater(TCollection_HAsciiString other)
		{
			throw new NotImplementedException();
		}
		...
		public bool IsSameString(TCollection_HAsciiString S)
		{
			throw new NotImplementedException();
		}
