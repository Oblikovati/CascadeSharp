...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepFeat_MakePipe : CascadeSharp.BRepFeat_Form
	{
		...
		public BRepFeat_MakePipe(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, TopoDS_Wire Spine, int Fuse, bool Modify)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Init(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, TopoDS_Wire Spine, int Fuse, bool Modify)
		{
			throw new NotImplementedException();
		}
