...
namespace CascadeSharp
{
	...
	//---------------------------------------------------------------------
	public  sealed class BRepFeat_MakeRevol : CascadeSharp.BRepFeat_Form
	{
		...
		public BRepFeat_MakeRevol(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, gp_Ax1 Ax_is, int Fuse, bool Modify)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Init(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, gp_Ax1 Ax_is, int Fuse, bool Modify)
		{
			throw new NotImplementedException();
		}
