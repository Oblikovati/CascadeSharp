...
namespace CascadeSharp.TKFeat.BRepFeat
{
    ...
    public sealed class BRepFeat
    {
        ...
        public void ParametricMinMax(TopoDS_Shape S, Geom_Curve C, ref double prmin, ref double prmax,
            ref double prbmin, ref double prbmax, ref bool flag, bool Ori)
        {
            throw new NotImplementedException();
        }

        public void ParametricMinMax(TopoDS_Shape S, Geom_Curve C, ref double prmin, ref double prmax,
            ref double prbmin, ref double prbmax, ref bool flag)
        {
            throw new NotImplementedException();
        }
