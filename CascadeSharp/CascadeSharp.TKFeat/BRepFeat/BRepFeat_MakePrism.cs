...
namespace CascadeSharp.TKFeat.BRepFeat
{
    ...
    public sealed class BRepFeat_MakePrism : BRepFeat_Form
    {
        ...
        public BRepFeat_MakePrism(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, gp_Dir Direction,
        ...
        public void Init(TopoDS_Shape Sbase, TopoDS_Shape Pbase, TopoDS_Face Skface, gp_Dir Direction, int Fuse,
            bool Modify)
        {
            throw new NotImplementedException();
        }
