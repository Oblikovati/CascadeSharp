...
namespace CascadeSharp.TKFeat.BRepFeat
{
    ...
    public class BRepFeat_RibSlot : BRepBuilderAPI_MakeShape
    {
        ...
        public TopoDS_Face ChoiceOfFaces(TopTools_ListOfShape faces, Geom_Curve cc, double par, double bnd,
            Geom_Plane Pln)
        {
            throw new NotImplementedException();
        }
        ...
        public bool ExtremeFaces(bool RevolRib, double bnd, Geom_Plane Pln, TopoDS_Edge FirstEdge, TopoDS_Edge LastEdge,
            TopoDS_Face FirstFace, TopoDS_Face LastFace, TopoDS_Vertex FirstVertex, TopoDS_Vertex LastVertex,
            ref bool OnFirstFace, ref bool OnLastFace, ref bool PtOnFirstEdge, ref bool PtOnLastEdge,
            TopoDS_Edge OnFirstEdge, TopoDS_Edge OnLastEdge)
        {
            throw new NotImplementedException();
        }

        public void PtOnEdgeVertex(bool RevolRib, TopoDS_Shape shape, gp_Pnt point, TopoDS_Vertex FirstVertex,
            TopoDS_Vertex LastVertex, ref bool PtOnEdge, TopoDS_Edge OnEdge, ref bool PtOnVertex,
            TopoDS_Vertex OnVertex)
        {
            throw new NotImplementedException();
        }

        public bool SlidingProfile(TopoDS_Face Prof, bool RevolRib, double myTol, ref int Concavite, Geom_Plane myPln,
            TopoDS_Face BndFace, gp_Pnt CheckPnt, TopoDS_Face FirstFace, TopoDS_Face LastFace,
            TopoDS_Vertex FirstVertex, TopoDS_Vertex LastVertex, TopoDS_Edge FirstEdge, TopoDS_Edge LastEdge)
        {
            throw new NotImplementedException();
        }

        public bool NoSlidingProfile(TopoDS_Face Prof, bool RevolRib, double myTol, ref int Concavite, Geom_Plane myPln,
            double bnd, TopoDS_Face BndFace, gp_Pnt CheckPnt, TopoDS_Face FirstFace, TopoDS_Face LastFace,
            TopoDS_Vertex FirstVertex, TopoDS_Vertex LastVertex, TopoDS_Edge FirstEdge, TopoDS_Edge LastEdge,
            bool OnFirstFace, bool OnLastFace)
        {
            throw new NotImplementedException();
        }
