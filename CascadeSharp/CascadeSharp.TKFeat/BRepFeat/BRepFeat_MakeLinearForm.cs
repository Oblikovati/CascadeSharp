...
namespace CascadeSharp
{
	...
	public  sealed class BRepFeat_MakeLinearForm : CascadeSharp.BRepFeat_RibSlot
	{
		...
		public BRepFeat_MakeLinearForm(TopoDS_Shape Sbase, TopoDS_Wire W, Geom_Plane P, gp_Vec Direction, gp_Vec Direction1, int Fuse, bool Modify)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Init(TopoDS_Shape Sbase, TopoDS_Wire W, Geom_Plane P, gp_Vec Direction, gp_Vec Direction1, int Fuse, bool Modify)
		{
			throw new NotImplementedException();
		}
