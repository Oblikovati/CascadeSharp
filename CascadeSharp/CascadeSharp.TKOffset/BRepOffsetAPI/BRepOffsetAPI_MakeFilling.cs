...
namespace CascadeSharp.TKOffset.BRepOffsetAPI
{
    ...
    //---------------------------------------------------------------------
    public sealed class BRepOffsetAPI_MakeFilling : BRepBuilderAPI_MakeShape
    {
        public BRepOffsetAPI_MakeFilling(int Degree, int NbPtsOnCur, int NbIter, bool An_isotropie, double Tol2d,
            double Tol3d, double TolAng, double TolCurv, int MaxDeg, int MaxSegments)
            : base()
        {
        ...
        public BRepOffsetAPI_MakeFilling(int Degree, int NbPtsOnCur, int NbIter, bool An_isotropie, double Tol2d,
            double Tol3d, double TolAng, double TolCurv, int MaxDeg)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public int Add(TopoDS_Edge Constr, GeomAbs_Shape Order, bool IsBound)
        {
            throw new NotImplementedException();
        }
        ...
        public int Add(TopoDS_Edge Constr, TopoDS_Face Support, GeomAbs_Shape Order, bool IsBound)
        {
            throw new NotImplementedException();
        }
