...
namespace CascadeSharp.TKOffset.BRepOffsetAPI
{
    ...
    //---------------------------------------------------------------------
    public sealed class BRepOffsetAPI_NormalProjection : BRepBuilderAPI_MakeShape
    {
        ...
        public BRepOffsetAPI_NormalProjection(BRepOffsetAPI_NormalProjection parameter1)
            : base()
        {
            throw new NotImplementedException();
        }
