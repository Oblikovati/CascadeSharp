...
namespace CascadeSharp.TKOffset.BRepOffset
{
    ...
    public sealed class BRepOffset_MakeOffset
    {
        ...
        public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection,
            bool SelfInter, GeomAbs_JoinType Join, bool Thickening, bool RemoveIntEdges)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection,
            bool SelfInter, GeomAbs_JoinType Join, bool Thickening)
            : base()
        {
            throw new NotImplementedException();
        }
        ...
        public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection,
            bool SelfInter, GeomAbs_JoinType Join)
            : base()
        {
            throw new NotImplementedException();
        }
