...
namespace CascadeSharp.TKOffset.BRepOffset
{
	...
	public  sealed class BRepOffset_MakeOffset
	{
		...
		public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join, bool Thickening, bool RemoveIntEdges)
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join, bool Thickening)
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join)
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter)
			: base()
		{
			throw new NotImplementedException();
		}

		public BRepOffset_MakeOffset(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection)
			: base()
		{
			throw new NotImplementedException();
		}
		...
		public void Initialize(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join, bool Thickening, bool RemoveIntEdges)
		{
			throw new NotImplementedException();
		}

		public void Initialize(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join, bool Thickening)
		{
			throw new NotImplementedException();
		}

		public void Initialize(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter, GeomAbs_JoinType Join)
		{
			throw new NotImplementedException();
		}

		public void Initialize(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection, bool SelfInter)
		{
			throw new NotImplementedException();
		}

		public void Initialize(TopoDS_Shape S, double Offset, double Tol, BRepOffset_Mode Mode, bool Intersection)
		{
			throw new NotImplementedException();
		}
