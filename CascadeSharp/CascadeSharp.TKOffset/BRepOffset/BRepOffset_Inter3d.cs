...
namespace CascadeSharp.TKOffset.BRepOffset
{
    ...
    public sealed class BRepOffset_Inter3d
    {
        ...
        public void ConnexIntByInt(TopoDS_Shape SI, BRepOffset_DataMapOfShapeOffset MapSF, BRepOffset_Analyse A,
            TopTools_DataMapOfShapeShape MES, TopTools_DataMapOfShapeShape Build, TopTools_ListOfShape Failed,
            bool bIsPlanar)
        {
            throw new NotImplementedException();
        }
        ...
        public void ContextIntByInt(TopTools_IndexedMapOfShape ContextFaces, bool ExtentContext,
            BRepOffset_DataMapOfShapeOffset MapSF, BRepOffset_Analyse A, TopTools_DataMapOfShapeShape MES,
            TopTools_DataMapOfShapeShape Build, TopTools_ListOfShape Failed, bool bIsPlanar)
        {
            throw new NotImplementedException();
        }
