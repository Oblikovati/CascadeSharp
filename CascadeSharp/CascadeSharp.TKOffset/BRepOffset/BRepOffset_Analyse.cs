...
namespace CascadeSharp.TKOffset.BRepOffset
{
	...
	public  sealed class BRepOffset_Analyse
	{
		...
		public void AddFaces(TopoDS_Face theFace, TopoDS_Compound theCo, TopTools_MapOfShape theMap, ChFiDS_TypeOfConcavity theType)
		{
			throw new NotImplementedException();
		}

		public void AddFaces(TopoDS_Face theFace, TopoDS_Compound theCo, TopTools_MapOfShape theMap, ChFiDS_TypeOfConcavity theType1, ChFiDS_TypeOfConcavity theType2)
		{
			throw new NotImplementedException();
		}
