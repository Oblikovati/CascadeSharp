...
namespace CascadeSharp.TKOffset.BRepOffset
{
    ...
    public sealed class BRepOffset_SimpleOffset : BRepTools_Modification
    {
        ...
        public void FillEdgeData(TopoDS_Edge theEdge, TopTools_IndexedDataMapOfShapeListOfShape theEdgeFaceMap,
            int theIdx)
        {
            throw new NotImplementedException();
        }

        public void FillVertexData(TopoDS_Vertex theVertex, TopTools_IndexedDataMapOfShapeListOfShape theVertexEdgeMap,
            int theIdx)
        {
            throw new NotImplementedException();
        }
