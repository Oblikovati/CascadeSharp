...
namespace CascadeSharp.TKOffset.BRepOffset
{
	...
	public  sealed class BRepOffset_Tool
	{
		...
		public void OrientSection(TopoDS_Edge E, TopoDS_Face F1, TopoDS_Face F2,  ref TopAbs_Orientation O1,  ref TopAbs_Orientation O2)
		{
			throw new NotImplementedException();
		}
		...
		public bool FindCommonShapes(TopoDS_Shape theS1, TopoDS_Shape theS2, TopAbs_ShapeEnum theType, TopTools_ListOfShape theLSC)
		{
			throw new NotImplementedException();
		}

		public void Inter3D(TopoDS_Face F1, TopoDS_Face F2, TopTools_ListOfShape LInt1, TopTools_ListOfShape LInt2, TopAbs_State Side, TopoDS_Edge RefEdge, bool IsRefEdgeDefined)
		{
			throw new NotImplementedException();
		}

		public void Inter3D(TopoDS_Face F1, TopoDS_Face F2, TopTools_ListOfShape LInt1, TopTools_ListOfShape LInt2, TopAbs_State Side, TopoDS_Edge RefEdge)
		{
			throw new NotImplementedException();
		}

		public bool TryProject(TopoDS_Face F1, TopoDS_Face F2, TopTools_ListOfShape Edges, TopTools_ListOfShape LInt1, TopTools_ListOfShape LInt2, TopAbs_State Side, double TolConf)
		{
			throw new NotImplementedException();
		}

		public void PipeInter(TopoDS_Face F1, TopoDS_Face F2, TopTools_ListOfShape LInt1, TopTools_ListOfShape LInt2, TopAbs_State Side)
		{
			throw new NotImplementedException();
		}
		...
		public void InterOrExtent(TopoDS_Face F1, TopoDS_Face F2, TopTools_ListOfShape LInt1, TopTools_ListOfShape LInt2, TopAbs_State Side)
		{
			throw new NotImplementedException();
		}
		...
		public void ExtentFace(TopoDS_Face F, TopTools_DataMapOfShapeShape ConstShapes, TopTools_DataMapOfShapeShape ToBuild, TopAbs_State Side, double TolConf, TopoDS_Face NF)
		{
			throw new NotImplementedException();
		}
