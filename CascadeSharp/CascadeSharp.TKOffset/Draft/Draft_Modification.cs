...
namespace CascadeSharp.TKOffset.Draft
{
	...
	public  sealed class Draft_Modification : BRepTools_Modification
	{
		...
		public Geom_Curve NewCurve(Geom_Curve C, Geom_Surface S, TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane, bool Flag)
		{
			throw new NotImplementedException();
		}

		public Geom_Curve NewCurve(Geom_Curve C, Geom_Surface S, TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane)
		{
			throw new NotImplementedException();
		}

		public Geom_Surface NewSurface(Geom_Surface S, TopAbs_Orientation OriS, gp_Dir Direction, double Angle, gp_Pln NeutralPlane)
		{
			throw new NotImplementedException();
		}
